...
@Component({
  selector: 'app-sistemasuapa',
  templateUrl: './sistemasuapa.component.html',
  styleUrls: ['./sistemasuapa.component.scss']
})
export class SistemasUapaComponent implements OnInit {
  userId: string;
