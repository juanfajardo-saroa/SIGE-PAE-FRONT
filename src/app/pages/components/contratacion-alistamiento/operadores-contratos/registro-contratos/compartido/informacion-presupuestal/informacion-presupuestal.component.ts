...
@Component({
  selector: 'app-informacion-presupuestal',
  templateUrl: './informacion-presupuestal.component.html',
  styleUrls: ['./informacion-presupuestal.component.sass'],
  /* providers: [
    ContratosApiService,
    AsignacionRecursosApiService
  ] */
})
export class InformacionPresupuestalComponent implements OnInit,OnDestroy {
  @Input('iD_Contrato')
  ...
  public showValidationCDP: boolean = false;
  public showValidationCRP: boolean = false;

  public cdpTableDescription: any[] = [
    'Fecha CDP', 'Valor CDP', 'Archivo CDP', 'Acciones'
  ]
  public crpTableDescription: any[] =[
    'Fecha CRP', 'Valor CRP', 'Archivo CRP', 'Acciones'
  ]
  ...
  */
  ...
  filtrarCRPPorCDP(CRPs: any[], numeroCDP: number): any[] {
    return CRPs.filter(crp => crp.numeroCDP == numeroCDP);
  }
}
