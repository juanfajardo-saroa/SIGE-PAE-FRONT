 ...
 * 
 */
import { TablasAuditoriaModel } from "../TablasAuditoria";
import { TablasAuditoriaService } from "../TablasAuditoria.services";
/**
...
export class ListTablasAuditoriaComponent implements OnInit, AfterViewInit,OnDestroy  {
    ...
    private apiurl = environment.baseUrlAPI + "TablasAuditoria";
    ...
    displayedColumns: string[] = ['select',"id","esquema","table_Name","nombre","auditCampo","auditTabla", 'action'];
...
nombre:[data.nombre],
auditoria:[''],
auditCampo:[data.auditCampo],
auditTabla:[data.auditTabla],
});
