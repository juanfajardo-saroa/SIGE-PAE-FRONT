 ...
 */
@Component({
    selector: "app-list-TipoFuenteNutricional",
    templateUrl: "./list-TipoFuenteNutricional.component.html",
    styleUrls: ["./list-TipoFuenteNutricional.component.scss"],
  })
 ...
 *  
 */
export class ListTipoFuenteNutricionalComponent implements OnInit, AfterViewInit,OnDestroy  {
    ...
    TipoFuenteNutricionalDetail : TipoFuenteNutricionalModel | null=null;
    ...
    public dataSource!: MatTableDataSource<TipoFuenteNutricionalModel>;
    selection = new SelectionModel<TipoFuenteNutricionalModel >(true, []);
    ...
    constructor(public dialog: MatDialog,  private route : ActivatedRoute, public TipoFuenteNutricionalService: TipoFuenteNutricionalService) { }
      ...
      */
    ngOnInit(): void {
        this.TipoFuenteNutricionalService.getTipoFuenteNutricionalList().subscribe(
            (response: any) => {
              this.dataArray = response;
              this.isLoading = false;
              this.dataSource = new MatTableDataSource<TipoFuenteNutricionalModel>(this.dataArray);
    ...
    ngOnDestroy() {
      ...
      */
      ...
      openDialog(action: string, obj: any): void {
          obj.action = action;
          const dialogRef = this.dialog.open(DialogTipoFuenteNutricionalContent, {
              data: obj
          });
      ...
      addRowData(row_obj: TipoFuenteNutricionalModel ): void {
          this.TipoFuenteNutricionalService.addTipoFuenteNutricional(row_obj).subscribe(
              (response) => {
      ...
      updateRowData(row_obj: TipoFuenteNutricionalModel ): boolean | any {
          this.TipoFuenteNutricionalService.updateTipoFuenteNutricional(row_obj).subscribe(
              (response) => {
      ...
      deleteRowData(row_obj: TipoFuenteNutricionalModel ): boolean | any {
          const ideliminar= row_obj.id;
          this.TipoFuenteNutricionalService.deleteTipoFuenteNutricional(ideliminar).subscribe(
            (response) => {
...
@Component({
    ...
    templateUrl: 'list-TipoFuenteNutricional.dialog.component.html',
    styleUrls: ["./list-TipoFuenteNutricional.dialog.component.scss"],
})
 ...
 *  
 */
export class DialogTipoFuenteNutricionalContent {
    action: string;
    local_data: any;
    selectedImage: any = '';
    joiningDate: any = '';
    ...
    constructor(public dialogRef: MatDialogRef<DialogTipoFuenteNutricionalContent>,
        @Optional() @Inject(MAT_DIALOG_DATA) public data: TipoFuenteNutricionalModel,
