 ...
 * 
 */
import { MinutaAprobacionModel } from "src/app/shared/model/MinutaAprobacion";
import { MinutaAprobacionService } from "src/app/shared/services/MinutaAprobacion.services";
/**
 ...
 */
@Component({
    selector: "app-list-MinutaAprobacion",
    templateUrl: "./list-MinutaAprobacion.component.html",
    styleUrls: ["./list-MinutaAprobacion.component.scss"],
  })
 ...
 *  
 */
export class ListMinutaAprobacionComponent implements OnInit, AfterViewInit,OnDestroy  {
    ...
    MinutaAprobacionDetail : MinutaAprobacionModel | null=null;
    MinutaAprobacionList : MinutaAprobacionModel[]=[];
    currentYear = new Date().getFullYear();
    dateToday: number = Date.now();
    nombreETC =environment.nameETC;

    private dataArray: any;
    displayedColumns: string[] = ['select',"id","iD_TipoEstadoMinuta","recomendaciones","justificacion","adjuntoJustificacionPATH","rechazado","auditoria", 'action'];
    public dataSource!: MatTableDataSource<MinutaAprobacionModel>;
    selection = new SelectionModel<MinutaAprobacionModel >(true, []);
    ...
    constructor(public dialog: MatDialog,  private route : ActivatedRoute, public MinutaAprobacionService: MinutaAprobacionService) { }
      ...
      */
    ngOnInit(): void {
        this.MinutaAprobacionService.getMinutaAprobacionList().subscribe(
            (response: any) => {
              this.dataArray = response;
              this.isLoading = false;
              this.dataSource = new MatTableDataSource<MinutaAprobacionModel>(this.dataArray);
    ...
    ngOnDestroy() {
      ...
      */
      ...
      openDialog(action: string, obj: any): void {
          obj.action = action;
          const dialogRef = this.dialog.open(DialogMinutaAprobacionContent, {
              data: obj
          });
      ...
      addRowData(row_obj: MinutaAprobacionModel ): void {
          this.MinutaAprobacionService.addMinutaAprobacion(row_obj).subscribe(
              (response) => {
      ...
      updateRowData(row_obj: MinutaAprobacionModel ): boolean | any {
          this.MinutaAprobacionService.updateMinutaAprobacion(row_obj).subscribe(
              (response) => {
      ...
      deleteRowData(row_obj: MinutaAprobacionModel ): boolean | any {
          const ideliminar= row_obj.id;
          this.MinutaAprobacionService.deleteMinutaAprobacion(ideliminar).subscribe(
            (response) => {
...
@Component({
    ...
    templateUrl: 'list-MinutaAprobacion.dialog.component.html',
    styleUrls: ["./list-MinutaAprobacion.dialog.component.scss"],
})
 ...
 *  
 */
export class DialogMinutaAprobacionContent {
    action: string;
    local_data: any;
    selectedImage: any = '';
    joiningDate: any = '';
    ...
    constructor(public dialogRef: MatDialogRef<DialogMinutaAprobacionContent>,
        @Optional() @Inject(MAT_DIALOG_DATA) public data: MinutaAprobacionModel,
