 ...
 */
@Component({
    selector: "app-list-CiclosMenusNivelesEducativos",
    templateUrl: "./list-CiclosMenusNivelesEducativos.component.html",
    styleUrls: ["./list-CiclosMenusNivelesEducativos.component.scss"],
  })
 ...
 *  
 */
export class ListCiclosMenusNivelesEducativosComponent implements OnInit, AfterViewInit,OnDestroy  {
    ...
    CiclosMenusNivelesEducativosDetail : CiclosMenusNivelesEducativosModel | null=null;
    CiclosMenusNivelesEducativosList : CiclosMenusNivelesEducativosModel[]=[];
    currentYear = new Date().getFullYear();
    dateToday: number = Date.now();
    nombreETC =environment.nameETC;

    private dataArray: any;
    displayedColumns: string[] = ['select',"id","iD_CiclosMenu","siD_CiclosMenu","iD_TipoNivelEducativo","siD_TipoNivelEducativo","auditoria", 'action'];
    public dataSource!: MatTableDataSource<CiclosMenusNivelesEducativosModel>;
    selection = new SelectionModel<CiclosMenusNivelesEducativosModel >(true, []);
    ...
    constructor(public dialog: MatDialog,  private route : ActivatedRoute, public CiclosMenusNivelesEducativosService: CiclosMenusNivelesEducativosService) { }
      ...
      */
    ngOnInit(): void {
        this.CiclosMenusNivelesEducativosService.getCiclosMenusNivelesEducativosList().subscribe(
            (response: any) => {
              this.dataArray = response;
              this.isLoading = false;
              this.dataSource = new MatTableDataSource<CiclosMenusNivelesEducativosModel>(this.dataArray);
    ...
    ngOnDestroy() {
      ...
      */
      ...
      openDialog(action: string, obj: any): void {
          obj.action = action;
          const dialogRef = this.dialog.open(DialogCiclosMenusNivelesEducativosContent, {
              data: obj
          });
      ...
      addRowData(row_obj: CiclosMenusNivelesEducativosModel ): void {
          this.CiclosMenusNivelesEducativosService.addCiclosMenusNivelesEducativos(row_obj).subscribe(
              (response) => {
      ...
      updateRowData(row_obj: CiclosMenusNivelesEducativosModel ): boolean | any {
          this.CiclosMenusNivelesEducativosService.updateCiclosMenusNivelesEducativos(row_obj).subscribe(
              (response) => {
      ...
      deleteRowData(row_obj: CiclosMenusNivelesEducativosModel ): boolean | any {
          const ideliminar= row_obj.id;
          this.CiclosMenusNivelesEducativosService.deleteCiclosMenusNivelesEducativos(ideliminar).subscribe(
            (response) => {
...
@Component({
    ...
    templateUrl: 'list-CiclosMenusNivelesEducativos.dialog.component.html',
    styleUrls: ["./list-CiclosMenusNivelesEducativos.dialog.component.scss"],
})
 ...
 *  
 */
export class DialogCiclosMenusNivelesEducativosContent {
    action: string;
    local_data: any;
    selectedImage: any = '';
    joiningDate: any = '';
...
NivelEducativoList: NivelEducativoModel[];
    ...
    constructor(public dialogRef: MatDialogRef<DialogCiclosMenusNivelesEducativosContent>,
        @Optional() @Inject(MAT_DIALOG_DATA) public data: CiclosMenusNivelesEducativosModel,
        private fb:FormBuilder 
        , private ciclosMenusService:CiclosMenusService
, private nivelEducativoService:NivelEducativoService
    ...
    (response:any) => {
        this.CiclosMenusList = response;
    },
    (err)=>{
        console.log("Error al cargar los registros del selected de las CiclosMenus", err);
    }
 );
...
iD_CiclosMenu:[data.iD_CiclosMenu],
