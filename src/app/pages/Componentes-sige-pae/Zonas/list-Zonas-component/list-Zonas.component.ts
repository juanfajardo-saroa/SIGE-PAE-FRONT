 ...
 *  
 */
export class ListZonasComponent implements OnInit, AfterViewInit,OnDestroy  {
    ...
    ZonasDetail : ZonasModel | null=null;
    ...
    public dataSource!: MatTableDataSource<ZonasModel>;
    selection = new SelectionModel<ZonasModel >(true, []);
    ...
    constructor(public dialog: MatDialog,  private route : ActivatedRoute, public ZonasService: ZonasService) { }
    ...
    ngOnInit(): void {
        this.ZonasService.getZonasList().subscribe(
            (response: any) => {
              ...
              this.dataSource = new MatTableDataSource<ZonasModel>(this.dataArray);
    ...
    ngOnDestroy() {
      ...
      */
      ...
      openDialog(action: string, obj: any): void {
          obj.action = action;
          const dialogRef = this.dialog.open(DialogZonasContent, {
              data: obj
          });
      ...
      addRowData(row_obj: ZonasModel ): void {
          this.ZonasService.addZonas(row_obj).subscribe(
              (response) => {
      ...
      updateRowData(row_obj: ZonasModel ): boolean | any {
          this.ZonasService.updateZonas(row_obj).subscribe(
              (response) => {
      ...
      deleteRowData(row_obj: ZonasModel ): boolean | any {
          const ideliminar= row_obj.id;
          this.ZonasService.deleteZonas(ideliminar).subscribe(
            (response) => {
...
@Component({
    ...
    templateUrl: 'list-Zonas.dialog.component.html',
    styleUrls: ["./list-Zonas.dialog.component.scss"],
})
 ...
 *  
 */
export class DialogZonasContent {
    action: string;
    local_data: any;
    selectedImage: any = '';
    joiningDate: any = '';
    ...
    constructor(public dialogRef: MatDialogRef<DialogZonasContent>,
        @Optional() @Inject(MAT_DIALOG_DATA) public data: ZonasModel,
