...
@Component({
  selector: 'app-ptn-ciclos-de-menu',
  templateUrl: './ptn-ciclos-de-menu.component.html',
  styleUrls: ['./ptn-ciclos-de-menu.component.scss']
})
export class PTNCiclosDeMenuComponent implements OnInit {
