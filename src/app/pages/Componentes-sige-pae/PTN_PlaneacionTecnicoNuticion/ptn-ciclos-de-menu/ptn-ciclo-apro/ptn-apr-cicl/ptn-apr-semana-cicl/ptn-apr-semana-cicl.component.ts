...
import { PA_CicloMenuAportesNutricionalesPivMAERSem, } from 'src/app/shared/services/PA_CicloMenuAportesNutricionalesPivMAERsem.services';
...
@Component({
  selector: 'app-ptn-apr-semana-cicl',
  templateUrl: './ptn-apr-semana-cicl.component.html',
  styleUrls: ['./ptn-apr-semana-cicl.component.scss']
})
export class PtnAprSemanaCiclComponent implements OnInit {
