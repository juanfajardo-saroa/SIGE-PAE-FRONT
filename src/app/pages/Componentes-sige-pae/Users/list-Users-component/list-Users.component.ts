...
export class ListUsersComponent implements OnInit, AfterViewInit,OnDestroy  {
    ...
    UsersDetail : UsersModel | null=null;
    ...
    displayedColumns: string[] = ['select',"id","email","passwordhash","segurityStamp","userName","auditoria", 'action'];
    public dataSource!: MatTableDataSource<UsersModel>;
    ...
    constructor(public dialog: MatDialog,  private route : ActivatedRoute, public UsersService: UsersService) { }
    ...
    ngOnInit(): void {
        this.UsersService.getUsersList().subscribe(
            (response: any) => {
              ...
              this.dataSource = new MatTableDataSource<UsersModel>(this.dataArray);
    ...
    ngOnDestroy() {
      ...
      */
      ...
      openDialog(action: string, obj: any): void {
          obj.action = action;
          const dialogRef = this.dialog.open(DialogUsersContent, {
              data: obj
          });
      ...
      addRowData(row_obj: UsersModel ): void {
          this.UsersService.addUsers(row_obj).subscribe(
              (response) => {
      ...
      updateRowData(row_obj: UsersModel ): boolean | any {
          this.UsersService.updateUsers(row_obj).subscribe(
              (response) => {
      ...
      deleteRowData(row_obj: UsersModel ): boolean | any {
          const ideliminar= row_obj.id;
          this.UsersService.deleteUsers(ideliminar).subscribe(
            (response) => {
 ...
 *  
 */
export class DialogUsersContent {
    action: string;
    local_data: any;
    selectedImage: any = '';
    joiningDate: any = '';
    ...
    constructor(public dialogRef: MatDialogRef<DialogUsersContent>,
        @Optional() @Inject(MAT_DIALOG_DATA) public data: UsersModel,
...
segurityStamp:[data.segurityStamp],
