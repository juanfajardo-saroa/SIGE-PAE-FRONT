 ...
 */
@Component({
    selector: "app-list-MenuProductos",
    templateUrl: "./list-MenuProductos.component.html",
    styleUrls: ["./list-MenuProductos.component.scss"],
  })
 ...
 *  
 */
export class ListMenuProductosComponent implements OnInit, AfterViewInit,OnDestroy  {
    ...
    MenuProductosDetail : MenuProductosModel | null=null;
    MenuProductosList : MenuProductosModel[]=[];
    currentYear = new Date().getFullYear();
    dateToday: number = Date.now();
    nombreETC =environment.nameETC;

    private dataArray: any;
    displayedColumns: string[] = ['select',"id","iD_Menu","siD_Menu","iD_Producto","siD_Producto","auditoria", 'action'];
    public dataSource!: MatTableDataSource<MenuProductosModel>;
    selection = new SelectionModel<MenuProductosModel >(true, []);
    ...
    constructor(public dialog: MatDialog,  private route : ActivatedRoute, public MenuProductosService: MenuProductosService) { }
      ...
      */
    ngOnInit(): void {
        this.MenuProductosService.getMenuProductosList().subscribe(
            (response: any) => {
              this.dataArray = response;
              this.isLoading = false;
              this.dataSource = new MatTableDataSource<MenuProductosModel>(this.dataArray);
    ...
    ngOnDestroy() {
      ...
      */
      ...
      openDialog(action: string, obj: any): void {
          obj.action = action;
          const dialogRef = this.dialog.open(DialogMenuProductosContent, {
              data: obj
          });
      ...
      addRowData(row_obj: MenuProductosModel ): void {
          this.MenuProductosService.addMenuProductos(row_obj).subscribe(
              (response) => {
      ...
      updateRowData(row_obj: MenuProductosModel ): boolean | any {
          this.MenuProductosService.updateMenuProductos(row_obj).subscribe(
              (response) => {
      ...
      deleteRowData(row_obj: MenuProductosModel ): boolean | any {
          const ideliminar= row_obj.id;
          this.MenuProductosService.deleteMenuProductos(ideliminar).subscribe(
            (response) => {
...
@Component({
    ...
    templateUrl: 'list-MenuProductos.dialog.component.html',
    styleUrls: ["./list-MenuProductos.dialog.component.scss"],
})
 ...
 *  
 */
export class DialogMenuProductosContent {
    action: string;
    local_data: any;
    selectedImage: any = '';
    joiningDate: any = '';
...
ProductosList: ProductosModel[];
    ...
    constructor(public dialogRef: MatDialogRef<DialogMenuProductosContent>,
        @Optional() @Inject(MAT_DIALOG_DATA) public data: MenuProductosModel,
...
this.productosService.getProductosList().subscribe(
    ...
    (err)=>{
        console.log("Error al cargar los registros del selected de las Productos", err);
    }
 );
