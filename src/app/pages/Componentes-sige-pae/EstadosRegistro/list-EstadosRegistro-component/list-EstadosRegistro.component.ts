...
import { EstadosRegistroService } from "src/app/shared/services/EstadosRegistro.services";
/**
 ...
 */
@Component({
    selector: "app-list-EstadosRegistro",
    templateUrl: "./list-EstadosRegistro.component.html",
    styleUrls: ["./list-EstadosRegistro.component.scss"],
  })
 ...
 *  
 */
export class ListEstadosRegistroComponent implements OnInit, AfterViewInit,OnDestroy  {
    ...
    EstadosRegistroDetail : EstadosRegistroModel | null=null;
    EstadosRegistroList : EstadosRegistroModel[]=[];
    ...
    public dataSource!: MatTableDataSource<EstadosRegistroModel>;
    selection = new SelectionModel<EstadosRegistroModel >(true, []);
    ...
    constructor(public dialog: MatDialog,  private route : ActivatedRoute, public EstadosRegistroService: EstadosRegistroService) { }
      ...
      */
    ngOnInit(): void {
        this.EstadosRegistroService.getEstadosRegistroList().subscribe(
            (response: any) => {
              this.dataArray = response;
              this.isLoading = false;
              this.dataSource = new MatTableDataSource<EstadosRegistroModel>(this.dataArray);
    ...
    ngOnDestroy() {
      ...
      */
      ...
      openDialog(action: string, obj: any): void {
          obj.action = action;
          const dialogRef = this.dialog.open(DialogEstadosRegistroContent, {
              data: obj
          });
      ...
      addRowData(row_obj: EstadosRegistroModel ): void {
          this.EstadosRegistroService.addEstadosRegistro(row_obj).subscribe(
              (response) => {
      ...
      updateRowData(row_obj: EstadosRegistroModel ): boolean | any {
          this.EstadosRegistroService.updateEstadosRegistro(row_obj).subscribe(
              (response) => {
      ...
      deleteRowData(row_obj: EstadosRegistroModel ): boolean | any {
          const ideliminar= row_obj.id;
          this.EstadosRegistroService.deleteEstadosRegistro(ideliminar).subscribe(
            (response) => {
...
@Component({
    ...
    templateUrl: 'list-EstadosRegistro.dialog.component.html',
    styleUrls: ["./list-EstadosRegistro.dialog.component.scss"],
})
 ...
 *  
 */
export class DialogEstadosRegistroContent {
    action: string;
    local_data: any;
    selectedImage: any = '';
    joiningDate: any = '';
    ...
    constructor(public dialogRef: MatDialogRef<DialogEstadosRegistroContent>,
        @Optional() @Inject(MAT_DIALOG_DATA) public data: EstadosRegistroModel,
