 ...
 * 
 */
import { TiposActividadFisicaModel } from "src/app/shared/model/TiposActividadFisica";
 ...
 */
@Component({
    selector: "app-list-TiposActividadFisica",
    templateUrl: "./list-TiposActividadFisica.component.html",
    styleUrls: ["./list-TiposActividadFisica.component.scss"],
  })
 ...
 *  
 */
export class ListTiposActividadFisicaComponent implements OnInit, AfterViewInit,OnDestroy  {
    ...
    TiposActividadFisicaDetail : TiposActividadFisicaModel | null=null;
    TiposActividadFisicaList : TiposActividadFisicaModel[]=[];
    ...
    public dataSource!: MatTableDataSource<TiposActividadFisicaModel>;
    selection = new SelectionModel<TiposActividadFisicaModel >(true, []);
    ...
    constructor(public dialog: MatDialog,  private route : ActivatedRoute, public TiposActividadFisicaService: TiposActividadFisicaService) { }
      ...
      */
    ngOnInit(): void {
        this.TiposActividadFisicaService.getTiposActividadFisicaList().subscribe(
            (response: any) => {
              this.dataArray = response;
              this.isLoading = false;
              this.dataSource = new MatTableDataSource<TiposActividadFisicaModel>(this.dataArray);
    ...
    ngOnDestroy() {
      ...
      */
      ...
      openDialog(action: string, obj: any): void {
          obj.action = action;
          const dialogRef = this.dialog.open(DialogTiposActividadFisicaContent, {
              data: obj
          });
      ...
      addRowData(row_obj: TiposActividadFisicaModel ): void {
          this.TiposActividadFisicaService.addTiposActividadFisica(row_obj).subscribe(
              (response) => {
      ...
      updateRowData(row_obj: TiposActividadFisicaModel ): boolean | any {
          this.TiposActividadFisicaService.updateTiposActividadFisica(row_obj).subscribe(
              (response) => {
      ...
      deleteRowData(row_obj: TiposActividadFisicaModel ): boolean | any {
          const ideliminar= row_obj.id;
          this.TiposActividadFisicaService.deleteTiposActividadFisica(ideliminar).subscribe(
            (response) => {
...
@Component({
    ...
    templateUrl: 'list-TiposActividadFisica.dialog.component.html',
    styleUrls: ["./list-TiposActividadFisica.dialog.component.scss"],
})
 ...
 *  
 */
export class DialogTiposActividadFisicaContent {
    action: string;
    local_data: any;
    selectedImage: any = '';
    joiningDate: any = '';
    ...
    constructor(public dialogRef: MatDialogRef<DialogTiposActividadFisicaContent>,
        @Optional() @Inject(MAT_DIALOG_DATA) public data: TiposActividadFisicaModel,
