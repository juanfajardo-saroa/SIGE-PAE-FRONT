 ...
 */
@Component({
    selector: "app-list-CentroPobladosDeZona",
    templateUrl: "./list-CentroPobladosDeZona.component.html",
    styleUrls: ["./list-CentroPobladosDeZona.component.scss"],
  })
 ...
 *  
 */
export class ListCentroPobladosDeZonaComponent implements OnInit, AfterViewInit,OnDestroy  {
    ...
    CentroPobladosDeZonaDetail : CentroPobladosDeZonaModel | null=null;
    ...
    displayedColumns: string[] = ['select',"id","iD_DiviPola","siD_DiviPola","auditoria","iD_Zona", 'action'];
    public dataSource!: MatTableDataSource<CentroPobladosDeZonaModel>;
    selection = new SelectionModel<CentroPobladosDeZonaModel >(true, []);
    ...
    constructor(public dialog: MatDialog,  private route : ActivatedRoute, public CentroPobladosDeZonaService: CentroPobladosDeZonaService) { }
    ...
    ngOnInit(): void {
        this.CentroPobladosDeZonaService.getCentroPobladosDeZonaList().subscribe(
            (response: any) => {
              ...
              this.dataSource = new MatTableDataSource<CentroPobladosDeZonaModel>(this.dataArray);
    ...
    ngOnDestroy() {
      ...
      */
      ...
      openDialog(action: string, obj: any): void {
          obj.action = action;
          const dialogRef = this.dialog.open(DialogCentroPobladosDeZonaContent, {
              data: obj
          });
      ...
      addRowData(row_obj: CentroPobladosDeZonaModel ): void {
          this.CentroPobladosDeZonaService.addCentroPobladosDeZona(row_obj).subscribe(
              (response) => {
      ...
      updateRowData(row_obj: CentroPobladosDeZonaModel ): boolean | any {
          this.CentroPobladosDeZonaService.updateCentroPobladosDeZona(row_obj).subscribe(
              (response) => {
      ...
      deleteRowData(row_obj: CentroPobladosDeZonaModel ): boolean | any {
          const ideliminar= row_obj.id;
          this.CentroPobladosDeZonaService.deleteCentroPobladosDeZona(ideliminar).subscribe(
            (response) => {
...
@Component({
    ...
    templateUrl: 'list-CentroPobladosDeZona.dialog.component.html',
    styleUrls: ["./list-CentroPobladosDeZona.dialog.component.scss"],
})
 ...
 *  
 */
export class DialogCentroPobladosDeZonaContent {
    action: string;
    local_data: any;
    selectedImage: any = '';
    joiningDate: any = '';
    ...
    constructor(public dialogRef: MatDialogRef<DialogCentroPobladosDeZonaContent>,
        @Optional() @Inject(MAT_DIALOG_DATA) public data: CentroPobladosDeZonaModel,
    ...
    (err)=>{
        console.log("Error al cargar los registros del selected de las Divipolas", err);
    }
 );
...
id:[data.id],
iD_DiviPola:[data.iD_DiviPola,Validators.required],
auditoria:[''],
