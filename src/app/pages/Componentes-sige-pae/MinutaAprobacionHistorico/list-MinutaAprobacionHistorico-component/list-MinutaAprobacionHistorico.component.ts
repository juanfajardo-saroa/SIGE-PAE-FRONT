 ...
 * 
 */
import { MinutaAprobacionHistoricoModel } from "src/app/shared/model/MinutaAprobacionHistorico";
import { MinutaAprobacionHistoricoService } from "src/app/shared/services/MinutaAprobacionHistorico.services";
/**
 ...
 */
@Component({
    selector: "app-list-MinutaAprobacionHistorico",
    templateUrl: "./list-MinutaAprobacionHistorico.component.html",
    styleUrls: ["./list-MinutaAprobacionHistorico.component.scss"],
  })
 ...
 *  
 */
export class ListMinutaAprobacionHistoricoComponent implements OnInit, AfterViewInit,OnDestroy  {
    ...
    MinutaAprobacionHistoricoDetail : MinutaAprobacionHistoricoModel | null=null;
    MinutaAprobacionHistoricoList : MinutaAprobacionHistoricoModel[]=[];
    currentYear = new Date().getFullYear();
    dateToday: number = Date.now();
    nombreETC =environment.nameETC;

    private dataArray: any;
    displayedColumns: string[] = ['select',"id","iD_MinutaAprobacion","fechaAprobacion","iD_TipoEstadoMinuta","responsable","rolResponsable","accion","observaciones","auditoria", 'action'];
    public dataSource!: MatTableDataSource<MinutaAprobacionHistoricoModel>;
    selection = new SelectionModel<MinutaAprobacionHistoricoModel >(true, []);
    ...
    constructor(public dialog: MatDialog,  private route : ActivatedRoute, public MinutaAprobacionHistoricoService: MinutaAprobacionHistoricoService) { }
      ...
      */
    ngOnInit(): void {
        this.MinutaAprobacionHistoricoService.getMinutaAprobacionHistoricoList().subscribe(
            (response: any) => {
              this.dataArray = response;
              this.isLoading = false;
              this.dataSource = new MatTableDataSource<MinutaAprobacionHistoricoModel>(this.dataArray);
    ...
    ngOnDestroy() {
      ...
      */
      ...
      openDialog(action: string, obj: any): void {
          obj.action = action;
          const dialogRef = this.dialog.open(DialogMinutaAprobacionHistoricoContent, {
              data: obj
          });
      ...
      addRowData(row_obj: MinutaAprobacionHistoricoModel ): void {
          this.MinutaAprobacionHistoricoService.addMinutaAprobacionHistorico(row_obj).subscribe(
              (response) => {
      ...
      updateRowData(row_obj: MinutaAprobacionHistoricoModel ): boolean | any {
          this.MinutaAprobacionHistoricoService.updateMinutaAprobacionHistorico(row_obj).subscribe(
              (response) => {
      ...
      deleteRowData(row_obj: MinutaAprobacionHistoricoModel ): boolean | any {
          const ideliminar= row_obj.id;
          this.MinutaAprobacionHistoricoService.deleteMinutaAprobacionHistorico(ideliminar).subscribe(
            (response) => {
...
@Component({
    ...
    templateUrl: 'list-MinutaAprobacionHistorico.dialog.component.html',
    styleUrls: ["./list-MinutaAprobacionHistorico.dialog.component.scss"],
})
 ...
 *  
 */
export class DialogMinutaAprobacionHistoricoContent {
    action: string;
    local_data: any;
    selectedImage: any = '';
    joiningDate: any = '';
    ...
    constructor(public dialogRef: MatDialogRef<DialogMinutaAprobacionHistoricoContent>,
        @Optional() @Inject(MAT_DIALOG_DATA) public data: MinutaAprobacionHistoricoModel,
...
id:[data.id],
iD_MinutaAprobacion:[data.iD_MinutaAprobacion,Validators.required],
