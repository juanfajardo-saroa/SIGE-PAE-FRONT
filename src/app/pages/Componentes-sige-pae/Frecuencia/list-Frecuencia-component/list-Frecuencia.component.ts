 ...
 * 
 */
import { FrecuenciaModel } from "src/app/shared/model/Frecuencia";
import { FrecuenciaService } from "src/app/shared/services/Frecuencia.services";
/**
 ...
 */
@Component({
    selector: "app-list-Frecuencia",
    templateUrl: "./list-Frecuencia.component.html",
    styleUrls: ["./list-Frecuencia.component.scss"],
  })
 ...
 *  
 */
export class ListFrecuenciaComponent implements OnInit, AfterViewInit,OnDestroy  {
    ...
    FrecuenciaDetail : FrecuenciaModel | null=null;
    FrecuenciaList : FrecuenciaModel[]=[];
    ...
    public dataSource!: MatTableDataSource<FrecuenciaModel>;
    selection = new SelectionModel<FrecuenciaModel >(true, []);
    ...
    constructor(public dialog: MatDialog,  private route : ActivatedRoute, public FrecuenciaService: FrecuenciaService) { }
      ...
      */
    ngOnInit(): void {
        this.FrecuenciaService.getFrecuenciaList().subscribe(
            (response: any) => {
              this.dataArray = response;
              this.isLoading = false;
              this.dataSource = new MatTableDataSource<FrecuenciaModel>(this.dataArray);
    ...
    ngOnDestroy() {
      ...
      */
      ...
      openDialog(action: string, obj: any): void {
          obj.action = action;
          const dialogRef = this.dialog.open(DialogFrecuenciaContent, {
              data: obj
          });
      ...
      addRowData(row_obj: FrecuenciaModel ): void {
          this.FrecuenciaService.addFrecuencia(row_obj).subscribe(
              (response) => {
      ...
      updateRowData(row_obj: FrecuenciaModel ): boolean | any {
          this.FrecuenciaService.updateFrecuencia(row_obj).subscribe(
              (response) => {
      ...
      deleteRowData(row_obj: FrecuenciaModel ): boolean | any {
          const ideliminar= row_obj.id;
          this.FrecuenciaService.deleteFrecuencia(ideliminar).subscribe(
            (response) => {
...
@Component({
    ...
    templateUrl: 'list-Frecuencia.dialog.component.html',
    styleUrls: ["./list-Frecuencia.dialog.component.scss"],
})
 ...
 *  
 */
export class DialogFrecuenciaContent {
    action: string;
    local_data: any;
    selectedImage: any = '';
    joiningDate: any = '';
    ...
    constructor(public dialogRef: MatDialogRef<DialogFrecuenciaContent>,
        @Optional() @Inject(MAT_DIALOG_DATA) public data: FrecuenciaModel,
