...
@Component({
  selector: 'app-repositorios-normatividad',
  templateUrl: './repositorios-normatividad.component.html',
  styleUrls: ['./repositorios-normatividad.component.scss']
})
export class RepositoriosNormatividadComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  openDialog(action: string, obj: any): void {
    obj.action = action;
    const dialogRef = this.dialog.open(DialogRepositorioNormatividadContent, {
      data: obj
    });
...
@Component({
  ...
  templateUrl: 'repositorios-normatividad.dialog.component.html',
  styleUrls: ["./repositorios-normatividad.dialog.component.scss"],
})
// tslint:disable-next-line - Disables all
export class DialogRepositorioNormatividadContent {
  action: string;
  // tslint:disable-next-line - Disables all
  local_data: any;
  selectedImage: any = '';
  ...
  constructor(public dialogRef: MatDialogRef<DialogRepositorioNormatividadContent>,
