 ...
 *
 */
import { MinutaPatronConfiguracionModel } from "src/app/shared/model/MinutaPatronConfiguracion";
import { MinutaPatronConfiguracionService } from "src/app/shared/services/MinutaPatronConfiguracion.services";
/**
 ...
 */
@Component({
    selector: "app-list-MinutaPatronConfiguracion",
    templateUrl: "./list-MinutaPatronConfiguracion.component.html",
    styleUrls: ["./list-MinutaPatronConfiguracion.component.scss"],
  })
 ...
 *
 */
export class ListMinutaPatronConfiguracionComponent implements OnInit, AfterViewInit,OnDestroy  {
    ...
    MinutaPatronConfiguracionDetail : MinutaPatronConfiguracionModel | null=null;
    MinutaPatronConfiguracionList : MinutaPatronConfiguracionModel[]=[];
    currentYear = new Date().getFullYear();
    dateToday: number = Date.now();
    nombreETC =environment.nameETC;

    private dataArray: any;
    displayedColumns: string[] = ['select',"id","iD_TipoModeloOperacion","siD_TipoModeloOperacion","modalidadComplementoId","smodalidadComplementoId","tipoComplementoId","stipoComplementoId", 'action'];
    public dataSource!: MatTableDataSource<MinutaPatronConfiguracionModel>;
    selection = new SelectionModel<MinutaPatronConfiguracionModel >(true, []);
    ...
    constructor(public dialog: MatDialog,  private route : ActivatedRoute, public MinutaPatronConfiguracionService: MinutaPatronConfiguracionService) { }
      ...
      */
    ngOnInit(): void {
        this.MinutaPatronConfiguracionService.getMinutaPatronConfiguracionList().subscribe(
            (response: any) => {
              this.dataArray = response;
              this.isLoading = false;
              this.dataSource = new MatTableDataSource<MinutaPatronConfiguracionModel>(this.dataArray);
    ...
    ngOnDestroy() {
      ...
      */
      ...
      openDialog(action: string, obj: any): void {
          obj.action = action;
          const dialogRef = this.dialog.open(DialogMinutaPatronConfiguracionContent, {
              data: obj
          });
      ...
      addRowData(row_obj: MinutaPatronConfiguracionModel ): void {
          this.MinutaPatronConfiguracionService.addMinutaPatronConfiguracion(row_obj).subscribe(
              (response) => {
      ...
      updateRowData(row_obj: MinutaPatronConfiguracionModel ): boolean | any {
          this.MinutaPatronConfiguracionService.updateMinutaPatronConfiguracion(row_obj).subscribe(
              (response) => {
      ...
      deleteRowData(row_obj: MinutaPatronConfiguracionModel ): boolean | any {
          const ideliminar= row_obj.id;
          this.MinutaPatronConfiguracionService.deleteMinutaPatronConfiguracion(ideliminar).subscribe(
            (response) => {
...
@Component({
    ...
    templateUrl: 'list-MinutaPatronConfiguracion.dialog.component.html',
    styleUrls: ["./list-MinutaPatronConfiguracion.dialog.component.scss"],
})
 ...
 *
 */
export class DialogMinutaPatronConfiguracionContent {
    action: string;
    local_data: any;
    selectedImage: any = '';
    joiningDate: any = '';
...
TiposRacionList: TiposComplementoModel[];
    ...
    constructor(public dialogRef: MatDialogRef<DialogMinutaPatronConfiguracionContent>,
        @Optional() @Inject(MAT_DIALOG_DATA) public data: MinutaPatronConfiguracionModel,
