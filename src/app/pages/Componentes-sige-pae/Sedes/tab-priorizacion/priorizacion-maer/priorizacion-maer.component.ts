...
@Component({
  selector: 'app-priorizacion-maer',
  templateUrl: './priorizacion-maer.component.html',
  styleUrls: ['./priorizacion-maer.component.scss']
})
export class PriorizacionMaerComponent implements OnInit {
  ...
  prioSedeAsignaRacionPivListForever: PA_PrioSedeAsignaRacionPivModel[] = [];
  prioSedeAsignaRacionPivShow: PA_PrioSedeAsignaRacionPivModel[];
  ...
  fillDetailTable() {
    this.prioSedeAsignaRacionPivService.getPA_PrioSedeAsignaRacionPivList(this.prioSedeAsignaRacionPivParams).subscribe(
      (response: any) => {
        ...
        this.getTotal(this.prioSedeAsignaRacionPivList);
  ...
  fillJornadasTotales(pivList: PA_PrioSedeAsignaRacionPivModel[]): PA_PrioSedeAsignaRacionPivModel[] {
