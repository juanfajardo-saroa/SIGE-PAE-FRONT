...
@Component({
  selector: 'app-priorizacion-maem',
  templateUrl: './priorizacion-maem.component.html',
  styleUrls: ['./priorizacion-maem.component.scss']
})
export class PriorizacionMaemComponent implements OnInit {
  ...
  fillGeneralTable() {
    ...
    this.prioSedeAsignaRacionPivService.getPA_PrioSedeAsignaRacionPivList(this.prioSedeAsignaRacionPivParams).subscribe(
      (response: any) => {
        ...
        /*  this.jornadasList.forEach(jornada => {
           this.jornadasList.sort(function (a, b) {
             const nameA = a.nombre.toUpperCase(); // ignore upper and lowercase
             const nameB = b.nombre.toUpperCase(); // ignore upper and lowercase
             if (nameA < nameB) {
               return -1;
           ...
           this.prioSedeAsignaRacionPivList.forEach(element => {
             if (jornada.nombre == element.Jornada) {
               this.prioSedeAsignaRacionPivGeneralTemp.Jornada = jornada.nombre;
               ...
               this.prioSedeAsignaRacionPivGeneralTemp.m1_ComplementoAMPM += element.m1_ComplementoAMPM;
               ...
               this.prioSedeAsignaRacionPivGeneralTemp.m3_ComplementoAMPM += element.m3_ComplementoAMPM;
        ...
        this.getTotal2(this.prioSedeAsignaRacionPivList);
        ...
        this.dataSourceSedeGeneral = new MatTableDataSource<PA_PrioSedeAsignaRacionPivExtndModel>(this.prioSedeAsignaRacionPivGeneralList);
  ...
  fillDetailTable() {
    this.prioSedeAsignaRacionPivService.getPA_PrioSedeAsignaRacionPivList(this.prioSedeAsignaRacionPivParams).subscribe(
      (response: any) => {
        ...
        this.dataSourceSedeGeneral = new MatTableDataSource<PA_PrioSedeAsignaRacionPivExtndModel>(this.prioSedeAsignaRacionPivShow);
        this.spans = Object.assign({}, {
