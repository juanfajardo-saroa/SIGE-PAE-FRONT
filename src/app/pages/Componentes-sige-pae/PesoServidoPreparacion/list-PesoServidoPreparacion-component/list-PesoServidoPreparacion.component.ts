 ...
 */
@Component({
    selector: "app-list-PesoServidoPreparacion",
    templateUrl: "./list-PesoServidoPreparacion.component.html",
    styleUrls: ["./list-PesoServidoPreparacion.component.scss"],
  })
 ...
 *
 */
export class ListPesoServidoPreparacionComponent implements OnInit, AfterViewInit,OnDestroy  {
    ...
    PesoServidoPreparacionDetail : PesoServidoPreparacionModel | null=null;
    PesoServidoPreparacionList : PesoServidoPreparacionModel[]=[];
    currentYear = new Date().getFullYear();
    dateToday: number = Date.now();
    nombreETC =environment.nameETC;

    private dataArray: any;
    displayedColumns: string[] = ['select',"id","iD_TipoComplemento","siD_TipoComplemento","iD_TipoNivelEducativo","siD_TipoNivelEducativo","iD_Preparacion","siD_Preparacion","pesoServido","auditoria", 'action'];
    public dataSource!: MatTableDataSource<PesoServidoPreparacionModel>;
    selection = new SelectionModel<PesoServidoPreparacionModel >(true, []);
    ...
    constructor(public dialog: MatDialog,  private route : ActivatedRoute, public PesoServidoPreparacionService: PesoServidoPreparacionService) { }
      ...
      */
    ngOnInit(): void {
        this.PesoServidoPreparacionService.getPesoServidoPreparacionList().subscribe(
            (response: any) => {
              this.dataArray = response;
              this.isLoading = false;
              this.dataSource = new MatTableDataSource<PesoServidoPreparacionModel>(this.dataArray);
    ...
    ngOnDestroy() {
      ...
      */
      ...
      openDialog(action: string, obj: any): void {
          obj.action = action;
          const dialogRef = this.dialog.open(DialogPesoServidoPreparacionContent, {
              data: obj
          });
      ...
      addRowData(row_obj: PesoServidoPreparacionModel ): void {
          this.PesoServidoPreparacionService.addPesoServidoPreparacion(row_obj).subscribe(
              (response) => {
      ...
      updateRowData(row_obj: PesoServidoPreparacionModel ): boolean | any {
          this.PesoServidoPreparacionService.updatePesoServidoPreparacion(row_obj).subscribe(
              (response) => {
      ...
      deleteRowData(row_obj: PesoServidoPreparacionModel ): boolean | any {
          const ideliminar= row_obj.id;
          this.PesoServidoPreparacionService.deletePesoServidoPreparacion(ideliminar).subscribe(
            (response) => {
...
@Component({
    ...
    templateUrl: 'list-PesoServidoPreparacion.dialog.component.html',
    styleUrls: ["./list-PesoServidoPreparacion.dialog.component.scss"],
})
 ...
 *
 */
export class DialogPesoServidoPreparacionContent {
    action: string;
    local_data: any;
    selectedImage: any = '';
    joiningDate: any = '';
...
NivelEducativoList: NivelEducativoModel[];
    ...
    constructor(public dialogRef: MatDialogRef<DialogPesoServidoPreparacionContent>,
        @Optional() @Inject(MAT_DIALOG_DATA) public data: PesoServidoPreparacionModel,
...
pesoServido:[data.pesoServido,Validators.required],
auditoria:[''],
});
