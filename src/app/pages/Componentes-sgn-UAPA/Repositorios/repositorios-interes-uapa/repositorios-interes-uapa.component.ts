...
@Component({
  selector: 'app-repositorios-interes-uapa',
  templateUrl: './repositorios-interes-uapa.component.html',
  styleUrls: ['./repositorios-interes-uapa.component.scss']
})
export class RepositoriosInteresUapaComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  constructor(private RepositoriosService: RepositoriosExtendService,  public dialog: MatDialog, 
    ...
    openDialog(action: string, obj: any): void {
      obj.action = action;
      const dialogRef = this.dialog.open(DialogRepositorioInteresUAPAContent, {
        data: obj
      });
...
@Component({
  ...
  templateUrl: 'repositorios-interes-uapa.dialog.component.html',
  styleUrls: ["./repositorios-interes-uapa.dialog.component.scss"],
})
// tslint:disable-next-line - Disables all
export class DialogRepositorioInteresUAPAContent {
  action: string;
  // tslint:disable-next-line - Disables all
  local_data: any;
  selectedImage: any = '';
  ...
  constructor(public dialogRef: MatDialogRef<DialogRepositorioInteresUAPAContent>,
