...
@Component({
  selector: 'app-repositorios-documentos-uapa',
  templateUrl: './repositorios-documentos-uapa.component.html',
  styleUrls: ['./repositorios-documentos-uapa.component.scss']
})
export class RepositoriosDocumentosUapaComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  constructor(private RepositoriosService: RepositoriosExtendService, public dialog: MatDialog,
    ...
    private seguridadService: SeguridadService, private router: Router,
  ...
  openDialog(action: string, obj: any): void {
    obj.action = action;
    const dialogRef = this.dialog.open(DialogRepositorioDocumentosUAPAContent, {
      data: obj
    });
...
@Component({
  ...
  templateUrl: 'repositorios-documentos-uapa.dialog.component.html',
  styleUrls: ["./repositorios-documentos-uapa.dialog.component.scss"],
})
// tslint:disable-next-line - Disables all
export class DialogRepositorioDocumentosUAPAContent {
  action: string;
  // tslint:disable-next-line - Disables all
  local_data: any;
  selectedImage: any = '';
  ...
  constructor(public dialogRef: MatDialogRef<DialogRepositorioDocumentosUAPAContent>,
