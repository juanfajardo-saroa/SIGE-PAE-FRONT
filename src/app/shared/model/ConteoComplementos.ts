 ...
 */
export interface ConteoComplementosInterface {

        id:number;
    iD_AgrupacionMensual:number;
    siD_AgrupacionMensual:  string ; 
    iD_TiposModalidadComplemento:number;
 ...
 */
export class ConteoComplementosModel implements ConteoComplementosInterface {
    constructor(
  
        public id:number, 
    public iD_AgrupacionMensual:number, 
    public siD_AgrupacionMensual: string , 
    public iD_TiposModalidadComplemento:number, 
