 ...
 */
export interface PA_CicloMenuAportesNutricionalesPivSemInterface {
 ...
 */
export class PA_CicloMenuAportesNutricionalesPivSemModel implements PA_CicloMenuAportesNutricionalesPivSemInterface {
    constructor(
