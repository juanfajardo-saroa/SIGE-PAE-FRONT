...
/// Ano			      :2022
/// Arquitectura	:Modelo Base de Angular para Arquitectura Microservicios de la Entidad PA_QuincenaEntregaRacionesGetBySedeJornadaOperadorH
/// Capa			    :SISPAE-Front 
/// </Derechos_Reservados>

//Interface
export interface PA_QuincenaEntregaRacionesGetBySedeJornadaOperadorHInterface {
...
export class PA_QuincenaEntregaRacionesGetBySedeJornadaOperadorHModel implements PA_QuincenaEntregaRacionesGetBySedeJornadaOperadorHInterface {
    constructor(
