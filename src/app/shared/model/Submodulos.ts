 ...
 * Ano			    :2022
 * 
 * Arquitectura	    :Modelo Base de Angular para Arquitectura Microservicios de la Entidad Submodulos
 * 
 * Capa			    :SISPAE-Front 
 * 
 * </Derechos_Reservados>
 ...
 */
export interface SubmodulosInterface {
 ...
 */
export class SubmodulosModel implements SubmodulosInterface {
    constructor(
