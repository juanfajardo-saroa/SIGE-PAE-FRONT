 ...
 * Ano			    :2022
 * 
 * Arquitectura	    :Modelo Base de Angular para Arquitectura Microservicios de la Entidad PreparacionComplementos
 * 
 * Capa			    :SISPAE-Front 
 * 
 * </Derechos_Reservados>
 ...
 */
export interface PreparacionComplementosInterface {
 ...
 */
export class PreparacionComplementosModel implements PreparacionComplementosInterface {
    constructor(
