 ...
 */
export interface OperadoresAprobacionInterface {

        iD_OperadorAprobacion:number;
    iD_Operador:number;
    siD_Operador:  string ; 
 ...
 */
export class OperadoresAprobacionModel implements OperadoresAprobacionInterface {
    constructor(
  
        public iD_OperadorAprobacion:number, 
