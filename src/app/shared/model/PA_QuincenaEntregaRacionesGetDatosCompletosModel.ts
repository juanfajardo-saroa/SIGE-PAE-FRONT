...
/// Ano			      :2022
/// Arquitectura	:Modelo Base de Angular para Arquitectura Microservicios de la Entidad PA_QuincenaEntregaRacionesGetDatosCompletos
/// Capa			    :SISPAE-Front 
/// </Derechos_Reservados>

//Interface
export interface PA_QuincenaEntregaRacionesGetDatosCompletosInterface {
...
export class PA_QuincenaEntregaRacionesGetDatosCompletosModel implements PA_QuincenaEntregaRacionesGetDatosCompletosInterface {
    constructor(
