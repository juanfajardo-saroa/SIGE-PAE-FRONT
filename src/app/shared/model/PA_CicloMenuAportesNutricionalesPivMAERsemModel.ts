 ...
 */
export interface PA_CicloMenuAportesNutricionalesPivMAERsemInterface {
 ...
 */
export class PA_CicloMenuAportesNutricionalesPivMAERsemModel implements PA_CicloMenuAportesNutricionalesPivMAERsemInterface {
    constructor(
