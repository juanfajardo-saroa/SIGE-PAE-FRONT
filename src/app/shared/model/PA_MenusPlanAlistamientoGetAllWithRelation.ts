 ...
 */
export interface PA_MenusPlanAlistamientoGetAllWithRelationInterface {
 ...
 */
export class PA_MenusPlanAlistamientoGetAllWithRelationModel implements PA_MenusPlanAlistamientoGetAllWithRelationInterface {
    constructor(
