 ...
 * Ano			    :2022
 * 
 * Arquitectura	    :Modelo Base de Angular para Arquitectura Microservicios de la Entidad SemanaComponentes
 * 
 * Capa			    :SISPAE-Front 
 * 
 * </Derechos_Reservados>
 ...
 */
export interface SemanaComponentesInterface {
 ...
 */
export class SemanaComponentesModel implements SemanaComponentesInterface {
    constructor(
  
        public id:number, 
    public iD_Semana:number, 
    public siD_Semana: string , 
    ...
    public cantidadComponente:number, 
