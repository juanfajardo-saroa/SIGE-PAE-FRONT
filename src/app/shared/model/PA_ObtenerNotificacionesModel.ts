 ...
 */
export interface PA_ObtenerNotificacionesInterface {
 ...
 */
export class PA_ObtenerNotificacionesModel implements PA_ObtenerNotificacionesInterface {
  constructor(

    public id: number,
    public mensaje: string,
    public modulo: string,
    public urlMensaje: string,
    public estadoMensaje: number,
    public fechaMensaje: Date,
