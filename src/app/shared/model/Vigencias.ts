 ...
 */
export interface VigenciasInterface {

  id: number;
  nombre: string;
  ano: number;
  fechaInicial: Date;
  vigenciaActual: boolean;
  auditoria: string;
 ...
 */
export class VigenciasModel implements VigenciasInterface {
  constructor(
    ...
    public vigenciaActual: boolean = true,
    public auditoria: string,

    // atributos para gestión de auditoria del objeto
    public _ippublica: string = null,
    public _nombremaquina: string = null,
