...
/// Ano			      :2022
/// Arquitectura	:Modelo Base de Angular para Arquitectura Microservicios de la Entidad PA_QuincenaEntregaRacionesGetxGradoH
/// Capa			    :SISPAE-Front 
/// </Derechos_Reservados>

//Interface
export interface PA_QuincenaEntregaRacionesGetxGradoHInterface {
...
export class PA_QuincenaEntregaRacionesGetxGradoHModel implements PA_QuincenaEntregaRacionesGetxGradoHInterface {
    constructor(
