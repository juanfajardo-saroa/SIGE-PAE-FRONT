 ...
 */
export interface PA_PreparacionesGetAllWithRelationInterface {
    ...
    ID_ETC:number;
    Nombre:string;
    PreparacionMixta:string;
    PreparacionBebida:string;
 ...
 */
export class PA_PreparacionesGetAllWithRelationModel implements PA_PreparacionesGetAllWithRelationInterface {
    constructor(
    ...
    public PreparacionMixta:string, 
    public PreparacionBebida:string, 
