 ...
 */
export interface PA_ValidaIntercambiosInterface {

  ID_GrupoAlimento:number;
  Grupo:string;
  idComponente:number;
  Componente:string;
  minIntercambios:number;
 ...
 */
export class PA_ValidaIntercambiosModel implements PA_ValidaIntercambiosInterface {
    constructor(
      ...
      public minIntercambios:number, 
      public MaxIntercambios:number, 
