 ...
 */
export class MenusModel implements MenusInterface {
    constructor(
  
        public id:number, 
    public iD_TipoMenu:number, 
    public siD_TipoMenu: string , 
    public iD_TipoComplemento:number, 
    public siD_TipoComplemento: string , 
    public iD_ETC:number, 
    public siD_ETC: string , 
    public totalCostoMenu:number, 
    public costoTransporte:number, 
    public costoAlimentos:number, 
