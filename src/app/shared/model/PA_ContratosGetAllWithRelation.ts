 ...
 */
export interface PA_ContratosGetAllWithRelationInterface {
 ...
 */
export class PA_ContratosGetAllWithRelationModel implements PA_ContratosGetAllWithRelationInterface {
    constructor(
    ...
    public ConAnticipo:string, 
    public FechalnicioContrato:Date, 
    public ValorTotalContrato:string, 
