 ...
 */
export interface DetallesSumComplementosInterface {
    ...
    siD_Jornada:  string ; 
    complementos:number;
    diasSuministro:number;
    mesesSuministro:number;
    contratoPAEC:boolean;
    auditoria:string;
 ...
 */
export class DetallesSumComplementosModel implements DetallesSumComplementosInterface {
    constructor(
    ...
    public complementos:number, 
    public diasSuministro:number, 
    public mesesSuministro:number, 
    public contratoPAEC:boolean, 
