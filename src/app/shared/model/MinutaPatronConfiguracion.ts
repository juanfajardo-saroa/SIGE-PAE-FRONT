 ...
 */
export class MinutaPatronConfiguracionModel implements MinutaPatronConfiguracionInterface {
    constructor(
    ...
    public smodalidadComplementoId: string ,
    public tipoComplementoId:number,
    public stipoComplementoId: string ,
