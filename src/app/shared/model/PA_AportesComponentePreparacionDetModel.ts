 ...
 */
export interface PA_AportesComponentePreparacionDetInterface {
 ...
 */
export class PA_AportesComponentePreparacionDetModel implements PA_AportesComponentePreparacionDetInterface {
    constructor(
