 ...
 */
export interface PA_CicloMenuAportesNutricionalesPivMAERInterface {
 ...
 */
export class PA_CicloMenuAportesNutricionalesPivMAERModel implements PA_CicloMenuAportesNutricionalesPivMAERInterface {
    constructor(
