 ...
 * Ano			    :2022
 * 
 * Arquitectura	    :Modelo Base de Angular para Arquitectura Microservicios de la Entidad ModalidadModelo
 * 
 * Capa			    :SISPAE-Front 
 * 
 * </Derechos_Reservados>
 ...
 */
export interface ModalidadModeloInterface {
 ...
 */
export class ModalidadModeloModel implements ModalidadModeloInterface {
    constructor(
