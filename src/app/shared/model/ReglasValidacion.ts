 ...
 * Ano			    :2022
 * 
 * Arquitectura	    :Modelo Base de Angular para Arquitectura Microservicios de la Entidad ReglasValidacion
 * 
 * Capa			    :SISPAE-Front 
 * 
 * </Derechos_Reservados>
 ...
 */
export interface ReglasValidacionInterface {
 ...
 */
export class ReglasValidacionModel implements ReglasValidacionInterface {
    constructor(
