 ...
 */
export interface PA_CicloMenuAporteNutricionalXAprobacionInterface {
 ...
 */
export class PA_CicloMenuAporteNutricionalXAprobacionModel implements PA_CicloMenuAporteNutricionalXAprobacionInterface {
    constructor(
