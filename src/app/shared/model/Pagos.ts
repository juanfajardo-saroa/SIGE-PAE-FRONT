...
export interface PagosInterface {
    ...
    siD_Contrato:  string ; 
    fechaPago:Date;
    pATHSoportePago:string;
    valorTotalPago:number;
    justificacionTardio:string;
    mesPago:Date;
    iD_TiposEstadosPago:number;
    siD_TiposEstadosPago:  string ; 
    auditoria:string;
 ...
 */
export class PagosModel implements PagosInterface {
    constructor(
    ...
    public pATHSoportePago:string, 
    public valorTotalPago:number, 
    public justificacionTardio:string, 
    public mesPago:Date, 
    public iD_TiposEstadosPago:number, 
    public siD_TiposEstadosPago: string , 
