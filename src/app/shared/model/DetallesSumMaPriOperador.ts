 ...
 */
export interface DetallesSumMaPriOperadorInterface {
 ...
 */
export class DetallesSumMaPriOperadorModel implements DetallesSumMaPriOperadorInterface {
    constructor(
    ...
    public unidadesContratadas:number, 
