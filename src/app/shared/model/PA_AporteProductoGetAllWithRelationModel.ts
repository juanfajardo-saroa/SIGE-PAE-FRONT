 ...
 */
export interface PA_AporteProductoGetAllWithRelationInterface {
 ...
 */
export class PA_AporteProductoGetAllWithRelationModel implements PA_AporteProductoGetAllWithRelationInterface {
    constructor(
