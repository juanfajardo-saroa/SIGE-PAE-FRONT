 ...
 */
export interface CajaHerramientaInterface {

        id:number;
    id_AnexoRecurso:number;
    sid_AnexoRecurso:  string ; 
    pATHArchivo:string;
    nombre:string;
    descripcion:string;
 ...
 */
export class CajaHerramientaModel implements CajaHerramientaInterface {
    constructor(
  
        public id:number, 
    public id_AnexoRecurso:number, 
    public sid_AnexoRecurso: string , 
