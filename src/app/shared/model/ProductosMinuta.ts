 ...
 */
export interface ProductosMinutaInterface {

        id:number;
    iD_MinutaPatronProducto:number;
    siD_MinutaPatronProducto:  string ; 
 ...
 */
export class ProductosMinutaModel implements ProductosMinutaInterface {
    constructor(
  
        public id:number, 
    public iD_MinutaPatronProducto:number, 
    public siD_MinutaPatronProducto: string , 
