 ...
 */
export interface PA_PesoServidoPreparacionGetAllWithRelationInterface {
 ...
 */
export class PA_PesoServidoPreparacionGetAllWithRelationModel implements PA_PesoServidoPreparacionGetAllWithRelationInterface {
    constructor(
