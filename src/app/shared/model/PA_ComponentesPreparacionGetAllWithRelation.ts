 ...
 */
export interface PA_ComponentesPreparacionGetAllWithRelationInterface {
 ...
 */
export class PA_ComponentesPreparacionGetAllWithRelationModel implements PA_ComponentesPreparacionGetAllWithRelationInterface {
    constructor(
