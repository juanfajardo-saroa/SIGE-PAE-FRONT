 ...
 * Ano			    :2022
 * 
 * Arquitectura	    :Modelo Base de Angular para Arquitectura Microservicios de la Entidad CostosComplementos
 * 
 * Capa			    :SISPAE-Front 
 * 
 * </Derechos_Reservados>
 ...
 */
export interface CostosComplementosInterface {
    ...
    valorComplementoCantidad:number;
    auditoria:string;
 ...
 */
export class CostosComplementosModel implements CostosComplementosInterface {
    constructor(
    ...
    public valorComplemento:number, 
    public valorComplementoCantidad:number, 
