 ...
 */
export interface DivipolasComprasLocalesInterface {

        id:number;
    iD_ComprasLocales:number;
    siD_ComprasLocales:  string ; 
    iD_divipola:number;
    siD_divipola:  string ; 
    nombre:string;
    auditoria:string;
 ...
 */
export class DivipolasComprasLocalesModel implements DivipolasComprasLocalesInterface {
    constructor(
  
        public id:number, 
    public iD_ComprasLocales:number, 
    public siD_ComprasLocales: string , 
