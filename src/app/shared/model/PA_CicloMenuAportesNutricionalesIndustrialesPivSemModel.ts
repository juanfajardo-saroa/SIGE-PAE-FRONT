 ...
 */
export interface PA_CicloMenuAportesNutricionalesIndustrialesPivSemInterface {
 ...
 */
export class PA_CicloMenuAportesNutricionalesIndustrialesPivSemModel implements PA_CicloMenuAportesNutricionalesIndustrialesPivSemInterface {
    constructor(
