 ...
 */
export interface PlanesAlistamientosAprobacionInterface {

        id:number;
    iD_PlanAlistamiento:number;
    siD_PlanAlistamiento:  string ; 
    iD_EstadoAlistamiento:number;
    fechaAprobacion:Date;
    iD_EstadoDocumento:number;
    siD_EstadoDocumento:  string ; 
    responsable:string;
 ...
 */
export class PlanesAlistamientosAprobacionModel implements PlanesAlistamientosAprobacionInterface {
    constructor(
  
        public id:number, 
    public iD_PlanAlistamiento:number, 
    public siD_PlanAlistamiento: string , 
    public iD_EstadoAlistamiento:number, 
    public fechaAprobacion:Date, 
    public iD_EstadoDocumento:number, 
    public siD_EstadoDocumento: string , 
