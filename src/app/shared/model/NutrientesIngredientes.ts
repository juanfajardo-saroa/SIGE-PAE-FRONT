 ...
 */
export interface NutrientesIngredientesInterface {

        id:number;
    iD_Ingrediente:number;
    siD_Ingrediente:  string ; 
    iD_Nutriente:number;
 ...
 */
export class NutrientesIngredientesModel implements NutrientesIngredientesInterface {
    constructor(
  
        public id:number, 
    public iD_Ingrediente:number, 
    public siD_Ingrediente: string , 
