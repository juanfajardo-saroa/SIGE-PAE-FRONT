...
import { AprobacionesModel } from "../model/aprobaciones.model";
//
...
export class AprobacionesService {
  ...
  deleteAprobaciones(id: number): Observable<AprobacionesModel> {
    ...
    this.Aprobaciones = this.Aprobaciones.filter((AprobacionesModel) => AprobacionesModel.id !== id);
    return this.http
      .delete<AprobacionesModel>(url)
      .pipe(
