 ...
 * Ano			    :2022
 * 
 * Arquitectura	    :Modelo Base de Angular para Arquitectura Microservicios de la Entidad PA_CicloMenuAportesNutricionalesPivSem
 * 
...
/**
 *  decorador injectable indica que esta clase PA_CicloMenuAportesNutricionalesPivSem puede ser inyectada dinamicamente
 *
 *  
 */
 ...
 *  
 */
import { PA_CicloMenuAportesNutricionalesPivSemModel } from "src/app/shared/model/PA_CicloMenuAportesNutricionalesPivSemModel";
 ...
 *  
 */
export class PA_CicloMenuAportesNutricionalesPivSemService {
  constructor(private http: HttpClient,private messageService:MessageService) {}

  // Definición de Variables requeridas
  private apiurl = environment.baseUrlAPI_PTN + "PA_CicloMenuAportesNutricionalesPivSem";
  private filterArray: PA_CicloMenuAportesNutricionalesPivSemModel[] = [];
  private PA_CicloMenuAportesNutricionalesPivSem: PA_CicloMenuAportesNutricionalesPivSemModel[] = [];
  private PA_CicloMenuAportesNutricionalesPivSemList: PA_CicloMenuAportesNutricionalesPivSemModel[] = [];
  private PA_CicloMenuAportesNutricionalesPivSemObject: PA_CicloMenuAportesNutricionalesPivSemModel;
  ...
  private handleError(error: any) {
    ...
    */
 getPA_CicloMenuAportesNutricionalesPivSemList(PA_CicloMenuAportesNutricionalesPiv: PA_CicloMenuAportesNutricionalesPivSem): Observable<PA_CicloMenuAportesNutricionalesPivSemModel> {
  ...
  let params = new HttpParams().set('ID_Etc', PA_CicloMenuAportesNutricionalesPiv.ID_Etc);
    ...
    return this.http
      .get<PA_CicloMenuAportesNutricionalesPivSemModel>(url, { params: params })
      .pipe(
...
export class PA_CicloMenuAportesNutricionalesPivSem{
  ID_Etc?: number;
