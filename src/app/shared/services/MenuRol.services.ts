 ...
 * Ano			    :2022
 * 
 * Arquitectura	    :Modelo Base de Angular para Arquitectura Microservicios de la Entidad MenuRol
 * 
...
/**
 *  decorador injectable indica que esta clase MenuRol puede ser inyectada dinamicamente
 *
 *  
 */
 ...
 *  
 */
import { MenuRolModel } from "../model/MenuRol";
...
export class MenuRolService {
  ...
  private apiurl = environment.baseUrlAPI_Seguridad + "MenuRol";
  private filterArray: MenuRolModel[] = [];
  private MenuRol: MenuRolModel[] = [];
  private MenuRolList: MenuRolModel[] = [];
  private MenuRolObject: MenuRolModel;
  ...
  private handleError(error: any) {
    ...
    */
  getMenuRolList(): Observable<MenuRolModel> {
    const url = `${this.apiurl}/GetAll/`;
    return this.http
      .get<MenuRolModel>(url)
      .pipe(
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getMenuRolListFull(): Observable<MenuRolModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getMenuRolListRelation(): Observable<MenuRolModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getMenuRol(id: number): Observable<MenuRolModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  deleteMenuRol(id: number): Observable<MenuRolModel> {

    var MenuRolObject = new MenuRolModel(id,0,'','',
    ...
    return this.http
      .post<MenuRolModel>(url, JSON.stringify(MenuRolObject),this.httpOptions)
      .pipe(
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  addMenuRol(MenuRol: MenuRolModel): Observable<MenuRolModel> {
    MenuRol.id = 0;
    MenuRol.auditoria ="{'RolBase':'"+localStorage.getItem("RolBase")+"'},"+
    ...
    MenuRol._usuario=localStorage.getItem('NombreUsuario');
    MenuRol._accion="Adicionar";
    MenuRol._ippublica=localStorage.getItem('IpPublica');
    MenuRol._browser=localStorage.getItem("Browser");
    MenuRol._nombremaquina=localStorage.getItem("NombreMaquina");
    MenuRol._sessionid=localStorage.getItem("Ubicacion");

    const url = `${this.apiurl}/Post/`;
    return this.http
      .post<MenuRolModel>(url, JSON.stringify(MenuRol),this.httpOptions)
      .pipe(
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  updateMenuRol(MenuRol: MenuRolModel): Observable<MenuRolModel> {
    MenuRol.auditoria ="{'RolBase':'"+localStorage.getItem("RolBase")+"'},"+
    "{'RolPersonalizado':'"+          localStorage.getItem("RolPersonalizado")+"'},"+
    "{'NombreUsuario':'"+        localStorage.getItem("NombreUsuario")+"'},"+
    "{'Ubicacion':'"+    localStorage.getItem("Ubicacion")+"'},"+
    ...
    return this.http
      .put<MenuRolModel>(url, JSON.stringify(MenuRol),this.httpOptions)
      .pipe(
