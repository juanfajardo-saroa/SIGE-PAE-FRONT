 ...
 * Ano			    :2022
 * 
 * Arquitectura	    :Modelo Base de Angular para Arquitectura Microservicios de la Entidad Meses
 * 
...
/**
 *  decorador injectable indica que esta clase Meses puede ser inyectada dinamicamente
 *
 *  
 */
 ...
 *  
 */
import { MesesModel } from "../model/Meses";
...
export class MesesService {
  ...
  private apiurl = environment.baseUrlAPI_Configuracion + "Meses";
  private filterArray: MesesModel[] = [];
  private Meses: MesesModel[] = [];
  private MesesList: MesesModel[] = [];
  private MesesObject: MesesModel;
  ...
  private handleError(error: any) {
    ...
    */
  getMesesList(): Observable<MesesModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getMesesListFull(): Observable<MesesModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getMesesListRelation(): Observable<MesesModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getMeses(id: number): Observable<MesesModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  deleteMeses(id: number): Observable<MesesModel> {

    var MesesObject = new MesesModel(id,0,'','',
    ...
    return this.http
      .post<MesesModel>(url, JSON.stringify(MesesObject),this.httpOptions)
      .pipe(
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  addMeses(Meses: MesesModel): Observable<MesesModel> {
    Meses.id = 0;
    Meses.auditoria ="{'RolBase':'"+localStorage.getItem("RolBase")+"'},"+
    ...
    Meses._usuario=localStorage.getItem('NombreUsuario');
    Meses._accion="Adicionar";
    Meses._ippublica=localStorage.getItem('IpPublica');
    Meses._browser=localStorage.getItem("Browser");
    Meses._nombremaquina=localStorage.getItem("NombreMaquina");
    Meses._sessionid=localStorage.getItem("Ubicacion");

    const url = `${this.apiurl}/Post/`;
    return this.http
      .post<MesesModel>(url, JSON.stringify(Meses),this.httpOptions)
      .pipe(
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  updateMeses(Meses: MesesModel): Observable<MesesModel> {
    Meses.auditoria ="{'RolBase':'"+localStorage.getItem("RolBase")+"'},"+
    "{'RolPersonalizado':'"+          localStorage.getItem("RolPersonalizado")+"'},"+
    "{'NombreUsuario':'"+        localStorage.getItem("NombreUsuario")+"'},"+
    "{'Ubicacion':'"+    localStorage.getItem("Ubicacion")+"'},"+
    ...
    return this.http
      .put<MesesModel>(url, JSON.stringify(Meses),this.httpOptions)
      .pipe(
