...
/**
 *  decorador injectable indica que esta clase PlanGiros puede ser inyectada dinamicamente
 *
 *  
 */
 ...
 *  
 */
import { PlanGirosModel } from "../model/PlanGiros";
 ...
 *  
 */
export class PlanGirosService {
  constructor(private http: HttpClient,private messageService:MessageService) {}

  // Definición de Variables requeridas
  private apiurl = environment.baseUrlAPI_ModuloUApa + "PlanGiros";
  private filterArray: PlanGirosModel[] = [];
  private PlanGiros: PlanGirosModel[] = [];
  private PlanGirosList: PlanGirosModel[] = [];
  private PlanGirosObject: PlanGirosModel;
  ...
  private handleError(error: any) {
    ...
    */
  getPlanGirosList(): Observable<PlanGirosModel> {
    const url = `${this.apiurl}/GetAll/`;
    return this.http
      .get<PlanGirosModel>(url)
      .pipe(
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getPlanGirosListFull(): Observable<PlanGirosModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getPlanGirosListRelation(): Observable<PlanGirosModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getPlanGiros(id: number): Observable<PlanGirosModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  deletePlanGiros(id: number): Observable<PlanGirosModel> {

    var PlanGirosObject = new PlanGirosModel(id,0,'','',0,0,'','','','','',0,'',new Date(),'','',
    ...
    return this.http
      .post<PlanGirosModel>(url, JSON.stringify(PlanGirosObject),this.httpOptions)
      .pipe(
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  addPlanGiros(PlanGiros: PlanGirosModel): Observable<PlanGirosModel> {
    PlanGiros.id = 0;
    PlanGiros.auditoria ="{'RolBase':'"+localStorage.getItem("RolBase")+"'},"+
    ...
    PlanGiros._usuario=localStorage.getItem('NombreUsuario');
    PlanGiros._accion="Adicionar";
    PlanGiros._ippublica=localStorage.getItem('IpPublica');
    PlanGiros._browser=localStorage.getItem("Browser");
    PlanGiros._nombremaquina=localStorage.getItem("NombreMaquina");
    PlanGiros._sessionid=localStorage.getItem("Ubicacion");

    const url = `${this.apiurl}/Post/`;
    return this.http
      .post<PlanGirosModel>(url, JSON.stringify(PlanGiros),this.httpOptions)
      .pipe(
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  updatePlanGiros(PlanGiros: PlanGirosModel): Observable<PlanGirosModel> {
    PlanGiros.auditoria ="{'RolBase':'"+localStorage.getItem("RolBase")+"'},"+
    "{'RolPersonalizado':'"+          localStorage.getItem("RolPersonalizado")+"'},"+
    "{'NombreUsuario':'"+        localStorage.getItem("NombreUsuario")+"'},"+
    "{'Ubicacion':'"+    localStorage.getItem("Ubicacion")+"'},"+
    ...
    return this.http
      .put<PlanGirosModel>(url, JSON.stringify(PlanGiros),this.httpOptions)
      .pipe(
