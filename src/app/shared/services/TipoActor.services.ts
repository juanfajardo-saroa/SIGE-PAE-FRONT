...
/**
 *  decorador injectable indica que esta clase TipoActor puede ser inyectada dinamicamente
 *
 *  
 */
 ...
 *  
 */
import { TipoActorModel } from "../model/TipoActor";
...
export class TipoActorService {
  ...
  private apiurl = environment.baseUrlAPI_Seguridad + "TipoActor";
  private filterArray: TipoActorModel[] = [];
  private TipoActor: TipoActorModel[] = [];
  private TipoActorList: TipoActorModel[] = [];
  private TipoActorObject: TipoActorModel;
  ...
  private handleError(error: any) {
    ...
    */
  getTipoActorList(): Observable<TipoActorModel> {
    const url = `${this.apiurl}/GetAll/`;
    return this.http
      .get<TipoActorModel>(url)
      .pipe(
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getTipoActorListFull(): Observable<TipoActorModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getTipoActorListRelation(): Observable<TipoActorModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getTipoActor(id: number): Observable<TipoActorModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  deleteTipoActor(id: number): Observable<TipoActorModel> {

    var TipoActorObject = new TipoActorModel(id,'','',
    ...
    return this.http
      .post<TipoActorModel>(url, JSON.stringify(TipoActorObject),this.httpOptions)
      .pipe(
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  addTipoActor(TipoActor: TipoActorModel): Observable<TipoActorModel> {
    TipoActor.id = 0;
    TipoActor.auditoria ="{'RolBase':'"+localStorage.getItem("RolBase")+"'},"+
    ...
    TipoActor._usuario=localStorage.getItem('NombreUsuario');
    TipoActor._accion="Adicionar";
    TipoActor._ippublica=localStorage.getItem('IpPublica');
    TipoActor._browser=localStorage.getItem("Browser");
    TipoActor._nombremaquina=localStorage.getItem("NombreMaquina");
    TipoActor._sessionid=localStorage.getItem("Ubicacion");

    const url = `${this.apiurl}/Post/`;
    return this.http
      .post<TipoActorModel>(url, JSON.stringify(TipoActor),this.httpOptions)
      .pipe(
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  updateTipoActor(TipoActor: TipoActorModel): Observable<TipoActorModel> {
    TipoActor.auditoria ="{'RolBase':'"+localStorage.getItem("RolBase")+"'},"+
    "{'RolPersonalizado':'"+          localStorage.getItem("RolPersonalizado")+"'},"+
    "{'NombreUsuario':'"+        localStorage.getItem("NombreUsuario")+"'},"+
    "{'Ubicacion':'"+    localStorage.getItem("Ubicacion")+"'},"+
    ...
    return this.http
      .put<TipoActorModel>(url, JSON.stringify(TipoActor),this.httpOptions)
      .pipe(
