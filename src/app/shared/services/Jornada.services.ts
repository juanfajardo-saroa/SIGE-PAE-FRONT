...
/**
 *  decorador injectable indica que esta clase Jornada puede ser inyectada dinamicamente
 *
 *  
 */
 ...
 *  
 */
import { JornadaModel } from "../model/Jornada";
...
export class JornadaService {
  ...
  private apiurl = environment.baseUrlAPI_SistemaEducativo + "Jornada";
  private filterArray: JornadaModel[] = [];
  private Jornada: JornadaModel[] = [];
  private JornadaList: JornadaModel[] = [];
  private JornadaObject: JornadaModel;
  ...
  private handleError(error: any) {
    ...
    */
  getJornadaList(): Observable<JornadaModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getJornadaListFull(): Observable<JornadaModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getJornadaListRelation(): Observable<JornadaModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getJornada(id: number): Observable<JornadaModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  deleteJornada(id: number): Observable<JornadaModel> {

    var JornadaObject = new JornadaModel(id,'','',
    ...
    return this.http
      .post<JornadaModel>(url, JSON.stringify(JornadaObject),this.httpOptions)
      .pipe(
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  addJornada(Jornada: JornadaModel): Observable<JornadaModel> {
    Jornada.id = 0;
    Jornada.auditoria ="{'RolBase':'"+localStorage.getItem("RolBase")+"'},"+
    ...
    Jornada._usuario=localStorage.getItem('NombreUsuario');
    Jornada._accion="Adicionar";
    Jornada._ippublica=localStorage.getItem('IpPublica');
    Jornada._browser=localStorage.getItem("Browser");
    Jornada._nombremaquina=localStorage.getItem("NombreMaquina");
    Jornada._sessionid=localStorage.getItem("Ubicacion");

    const url = `${this.apiurl}/Post/`;
    return this.http
      .post<JornadaModel>(url, JSON.stringify(Jornada),this.httpOptions)
      .pipe(
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  updateJornada(Jornada: JornadaModel): Observable<JornadaModel> {
    Jornada.auditoria ="{'RolBase':'"+localStorage.getItem("RolBase")+"'},"+
    "{'RolPersonalizado':'"+          localStorage.getItem("RolPersonalizado")+"'},"+
    "{'NombreUsuario':'"+        localStorage.getItem("NombreUsuario")+"'},"+
    "{'Ubicacion':'"+    localStorage.getItem("Ubicacion")+"'},"+
    ...
    return this.http
      .put<JornadaModel>(url, JSON.stringify(Jornada),this.httpOptions)
      .pipe(
