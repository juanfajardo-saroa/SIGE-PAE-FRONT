 ...
 * Ano			    :2022
 * 
 * Arquitectura	    :Modelo Base de Angular para Arquitectura Microservicios de la Entidad Grados
 * 
...
/**
 *  decorador injectable indica que esta clase Grados puede ser inyectada dinamicamente
 *
 *  
 */
 ...
 *  
 */
import { GradosModel } from "../model/Grados";
...
export class GradosService {
  ...
  private apiurl = environment.baseUrlAPI_SistemaEducativo + "Grados";
  private filterArray: GradosModel[] = [];
  private Grados: GradosModel[] = [];
  private GradosList: GradosModel[] = [];
  private GradosObject: GradosModel;
  ...
  private handleError(error: any) {
    ...
    */
  getGradosList(): Observable<GradosModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getGradosListFull(): Observable<GradosModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getGradosListRelation(): Observable<GradosModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getGrados(id: number): Observable<GradosModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  deleteGrados(id: number): Observable<GradosModel> {

    var GradosObject = new GradosModel(id,0,'',0,'','','',
    ...
    return this.http
      .post<GradosModel>(url, JSON.stringify(GradosObject),this.httpOptions)
      .pipe(
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  addGrados(Grados: GradosModel): Observable<GradosModel> {
    Grados.id = 0;
    Grados.auditoria ="{'RolBase':'"+localStorage.getItem("RolBase")+"'},"+
    ...
    Grados._usuario=localStorage.getItem('NombreUsuario');
    Grados._accion="Adicionar";
    Grados._ippublica=localStorage.getItem('IpPublica');
    Grados._browser=localStorage.getItem("Browser");
    Grados._nombremaquina=localStorage.getItem("NombreMaquina");
    Grados._sessionid=localStorage.getItem("Ubicacion");

    const url = `${this.apiurl}/Post/`;
    return this.http
      .post<GradosModel>(url, JSON.stringify(Grados),this.httpOptions)
      .pipe(
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  updateGrados(Grados: GradosModel): Observable<GradosModel> {
    Grados.auditoria ="{'RolBase':'"+localStorage.getItem("RolBase")+"'},"+
    "{'RolPersonalizado':'"+          localStorage.getItem("RolPersonalizado")+"'},"+
    "{'NombreUsuario':'"+        localStorage.getItem("NombreUsuario")+"'},"+
    "{'Ubicacion':'"+    localStorage.getItem("Ubicacion")+"'},"+
    ...
    return this.http
      .put<GradosModel>(url, JSON.stringify(Grados),this.httpOptions)
      .pipe(
