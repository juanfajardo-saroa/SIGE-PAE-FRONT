 ...
 * Ano			    :2022
 * 
 * Arquitectura	    :Modelo Base de Angular para Arquitectura Microservicios de la Entidad Inventario
 * 
...
/**
 *  decorador injectable indica que esta clase Inventario puede ser inyectada dinamicamente
 *
 *  
 */
 ...
 *  
 */
import { InventarioModel } from "../model/Inventario";
...
export class InventarioService {
  ...
  private apiurl = environment.baseUrlAPI_Infraestructura + "Inventario";
  private filterArray: InventarioModel[] = [];
  private Inventario: InventarioModel[] = [];
  private InventarioList: InventarioModel[] = [];
  private InventarioObject: InventarioModel;
  ...
  private handleError(error: any) {
    ...
    */
  getInventarioList(): Observable<InventarioModel> {
    const url = `${this.apiurl}/GetAll/`;
    return this.http
      .get<InventarioModel>(url)
      .pipe(
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getInventarioListFull(): Observable<InventarioModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getInventarioListRelation(): Observable<InventarioModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getInventario(id: number): Observable<InventarioModel> {
  ...
  deleteInventario(id: number): Observable<InventarioModel> {
    ...
    var InventarioObject = new InventarioModel(id,0,0,'',0,0,false,'',
    ...
    return this.http
      .post<InventarioModel>(url, JSON.stringify(InventarioObject),this.httpOptions)
      .pipe(
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  addInventario(Inventario: InventarioModel): Observable<InventarioModel> {
    Inventario.id = 0;
    Inventario.auditoria ="{'RolBase':'"+localStorage.getItem("RolBase")+"'},"+
    ...
    Inventario._usuario=localStorage.getItem('NombreUsuario');
    Inventario._accion="Adicionar";
    Inventario._ippublica=localStorage.getItem('IpPublica');
    Inventario._browser=localStorage.getItem("Browser");
    Inventario._nombremaquina=localStorage.getItem("NombreMaquina");
    Inventario._sessionid=localStorage.getItem("Ubicacion");

    const url = `${this.apiurl}/Post/`;
    return this.http
      .post<InventarioModel>(url, JSON.stringify(Inventario),this.httpOptions)
      .pipe(
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  updateInventario(Inventario: InventarioModel): Observable<InventarioModel> {
    Inventario.auditoria ="{'RolBase':'"+localStorage.getItem("RolBase")+"'},"+
    "{'RolPersonalizado':'"+          localStorage.getItem("RolPersonalizado")+"'},"+
    "{'NombreUsuario':'"+        localStorage.getItem("NombreUsuario")+"'},"+
    "{'Ubicacion':'"+    localStorage.getItem("Ubicacion")+"'},"+
    ...
    "{'NombreMaquina':'"+        localStorage.getItem("NombreMaquina")+"'}";
    Inventario._usuario=localStorage.getItem('NombreUsuario');
    Inventario._accion="Actuializar";
    Inventario._ippublica=localStorage.getItem('IpPublica');
    Inventario._browser=localStorage.getItem("Browser");
    Inventario._nombremaquina=localStorage.getItem("NombreMaquina");
    Inventario._sessionid=localStorage.getItem("Ubicacion");
    ...
    return this.http
      .put<InventarioModel>(url, JSON.stringify(Inventario),this.httpOptions)
      .pipe(
