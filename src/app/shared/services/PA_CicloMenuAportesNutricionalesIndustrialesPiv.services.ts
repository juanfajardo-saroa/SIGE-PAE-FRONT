...
/**
 *  decorador injectable indica que esta clase PA_CicloMenuAportesNutricionalesIndustrialesPiv puede ser inyectada dinamicamente
 *
 *  
 */
 ...
 *  
 */
import { PA_CicloMenuAportesNutricionalesIndustrialesPivModel } from "src/app/shared/model/PA_CicloMenuAportesNutricionalesIndustrialesPivModel";
 ...
 *  
 */
export class PA_CicloMenuAportesNutricionalesIndustrialesPivService {
  constructor(private http: HttpClient,private messageService:MessageService) {}

  // Definición de Variables requeridas
  private apiurl = environment.baseUrlAPI_PTN + "PA_CicloMenuAportesNutricionalesIndustrialesPiv";
  private filterArray: PA_CicloMenuAportesNutricionalesIndustrialesPivModel[] = [];
  private PA_CicloMenuAportesNutricionalesIndustrialesPiv: PA_CicloMenuAportesNutricionalesIndustrialesPivModel[] = [];
  private PA_CicloMenuAportesNutricionalesIndustrialesPivList: PA_CicloMenuAportesNutricionalesIndustrialesPivModel[] = [];
  private PA_CicloMenuAportesNutricionalesIndustrialesPivObject: PA_CicloMenuAportesNutricionalesIndustrialesPivModel;
  ...
  private handleError(error: any) {
    ...
    */
 getPA_CicloMenuAportesNutricionalesIndustrialesPivList(PA_CicloMenuAportesNutricionalesPiv: PA_CicloMenuAportesNutricionalesIndustrialesPiv): Observable<PA_CicloMenuAportesNutricionalesIndustrialesPivModel> {
  ...
  let params = new HttpParams().set('ID_Etc', PA_CicloMenuAportesNutricionalesPiv.ID_Etc);
    ...
    return this.http
      .get<PA_CicloMenuAportesNutricionalesIndustrialesPivModel>(url, { params: params })
      .pipe(
...
export class PA_CicloMenuAportesNutricionalesIndustrialesPiv{
  ID_Etc?: number;
