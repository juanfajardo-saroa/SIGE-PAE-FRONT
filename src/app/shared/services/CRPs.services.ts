...
/**
 *  decorador injectable indica que esta clase CRPs puede ser inyectada dinamicamente
 *
 *  
 */
 ...
 *  
 */
import { CRPsModel } from "../model/CRPs";
 ...
 *  
 */
export class CRPsService {
  constructor(private http: HttpClient,private messageService:MessageService) {}

  // Definición de Variables requeridas
  private apiurl = environment.baseUrlAPI_Contratos + "CRPs";
  private filterArray: CRPsModel[] = [];
  private CRPs: CRPsModel[] = [];
  private CRPsList: CRPsModel[] = [];
  private CRPsObject: CRPsModel;
  ...
  private handleError(error: any) {
    ...
    */
  getCRPsList(): Observable<CRPsModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getCRPsListFull(): Observable<CRPsModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getCRPsListRelation(): Observable<CRPsModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getCRPs(id: number): Observable<CRPsModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  deleteCRPs(id: number): Observable<CRPsModel> {

    var CRPsObject = new CRPsModel(id,0,'',0,0,0,0,'',
    ...
    return this.http
      .post<CRPsModel>(url, JSON.stringify(CRPsObject),this.httpOptions)
      .pipe(
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  addCRPs(CRPs: CRPsModel): Observable<CRPsModel> {
    CRPs.id = 0;
    CRPs.auditoria ="{'RolBase':'"+localStorage.getItem("RolBase")+"'},"+
    ...
    CRPs._usuario=localStorage.getItem('NombreUsuario');
    CRPs._accion="Adicionar";
    CRPs._ippublica=localStorage.getItem('IpPublica');
    CRPs._browser=localStorage.getItem("Browser");
    CRPs._nombremaquina=localStorage.getItem("NombreMaquina");
    CRPs._sessionid=localStorage.getItem("Ubicacion");

    const url = `${this.apiurl}/Post/`;
    return this.http
      .post<CRPsModel>(url, JSON.stringify(CRPs),this.httpOptions)
      .pipe(
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  updateCRPs(CRPs: CRPsModel): Observable<CRPsModel> {
    CRPs.auditoria ="{'RolBase':'"+localStorage.getItem("RolBase")+"'},"+
    "{'RolPersonalizado':'"+          localStorage.getItem("RolPersonalizado")+"'},"+
    "{'NombreUsuario':'"+        localStorage.getItem("NombreUsuario")+"'},"+
    "{'Ubicacion':'"+    localStorage.getItem("Ubicacion")+"'},"+
    ...
    return this.http
      .put<CRPsModel>(url, JSON.stringify(CRPs),this.httpOptions)
      .pipe(
