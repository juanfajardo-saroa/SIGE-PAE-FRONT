 ...
 * Ano			    :2022
 * 
 * Arquitectura	    :Modelo Base de Angular para Arquitectura Microservicios de la Entidad Sistema
 * 
...
/**
 *  decorador injectable indica que esta clase Sistema puede ser inyectada dinamicamente
 *
 *  
 */
 ...
 *  
 */
import { SistemaModel } from "../model/Sistema";
...
export class SistemaService {
  ...
  private apiurl = environment.baseUrlAPI_Seguridad + "Sistema";
  private filterArray: SistemaModel[] = [];
  private Sistema: SistemaModel[] = [];
  private SistemaList: SistemaModel[] = [];
  private SistemaObject: SistemaModel;
  ...
  private handleError(error: any) {
    ...
    */
  getSistemaList(): Observable<SistemaModel> {
    const url = `${this.apiurl}/GetAll/`;
    return this.http
      .get<SistemaModel>(url)
      .pipe(
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getSistemaListFull(): Observable<SistemaModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getSistemaListRelation(): Observable<SistemaModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getSistema(id: number): Observable<SistemaModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  deleteSistema(id: number): Observable<SistemaModel> {

    var SistemaObject = new SistemaModel(id,'','',
    ...
    return this.http
      .post<SistemaModel>(url, JSON.stringify(SistemaObject),this.httpOptions)
      .pipe(
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  addSistema(Sistema: SistemaModel): Observable<SistemaModel> {
    Sistema.id = 0;
    Sistema.auditoria ="{'RolBase':'"+localStorage.getItem("RolBase")+"'},"+
    ...
    Sistema._usuario=localStorage.getItem('NombreUsuario');
    Sistema._accion="Adicionar";
    Sistema._ippublica=localStorage.getItem('IpPublica');
    Sistema._browser=localStorage.getItem("Browser");
    Sistema._nombremaquina=localStorage.getItem("NombreMaquina");
    Sistema._sessionid=localStorage.getItem("Ubicacion");

    const url = `${this.apiurl}/Post/`;
    return this.http
      .post<SistemaModel>(url, JSON.stringify(Sistema),this.httpOptions)
      .pipe(
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  updateSistema(Sistema: SistemaModel): Observable<SistemaModel> {
    Sistema.auditoria ="{'RolBase':'"+localStorage.getItem("RolBase")+"'},"+
    "{'RolPersonalizado':'"+          localStorage.getItem("RolPersonalizado")+"'},"+
    "{'NombreUsuario':'"+        localStorage.getItem("NombreUsuario")+"'},"+
    "{'Ubicacion':'"+    localStorage.getItem("Ubicacion")+"'},"+
    ...
    return this.http
      .put<SistemaModel>(url, JSON.stringify(Sistema),this.httpOptions)
      .pipe(
