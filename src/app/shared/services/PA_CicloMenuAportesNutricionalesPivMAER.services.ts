 ...
 * Ano			    :2022
 * 
 * Arquitectura	    :Modelo Base de Angular para Arquitectura Microservicios de la Entidad PA_CicloMenuAportesNutricionalesPivMAER
 * 
...
/**
 *  decorador injectable indica que esta clase PA_CicloMenuAportesNutricionalesPivMAER puede ser inyectada dinamicamente
 *
 *  
 */
 ...
 *  
 */
import { PA_CicloMenuAportesNutricionalesPivMAERModel } from "src/app/shared/model/PA_CicloMenuAportesNutricionalesPivMAERModel";
 ...
 *  
 */
export class PA_CicloMenuAportesNutricionalesPivMAERService {
  constructor(private http: HttpClient,private messageService:MessageService) {}

  // Definición de Variables requeridas
  private apiurl = environment.baseUrlAPI_PTN + "PA_CicloMenuAportesNutricionalesPivMAER";
  private filterArray: PA_CicloMenuAportesNutricionalesPivMAERModel[] = [];
  private PA_CicloMenuAportesNutricionalesPivMAER: PA_CicloMenuAportesNutricionalesPivMAERModel[] = [];
  private PA_CicloMenuAportesNutricionalesPivMAERList: PA_CicloMenuAportesNutricionalesPivMAERModel[] = [];
  private PA_CicloMenuAportesNutricionalesPivMAERObject: PA_CicloMenuAportesNutricionalesPivMAERModel;
  ...
  private handleError(error: any) {
    ...
    */
 getPA_CicloMenuAportesNutricionalesPivMAERList(PA_CicloMenuAportesNutricionalesPiv: PA_CicloMenuAportesNutricionalesPivMAER): Observable<PA_CicloMenuAportesNutricionalesPivMAERModel> {
  ...
  const url = `${this.apiurl}/GetAll`;
    return this.http
      .get<PA_CicloMenuAportesNutricionalesPivMAERModel>(url, { params: params })
      .pipe(
...
export class PA_CicloMenuAportesNutricionalesPivMAER{
  ID_Etc?: number;
