...
/**
 *  decorador injectable indica que esta clase Ingresos puede ser inyectada dinamicamente
 *
 *  
 */
 ...
 *  
 */
import { IngresosModel } from "../model/Ingresos";
...
export class IngresosService {
  ...
  private apiurl = environment.baseUrlAPI_PlaneacionFinanciera + "Ingresos";
  private filterArray: IngresosModel[] = [];
  private Ingresos: IngresosModel[] = [];
  private IngresosList: IngresosModel[] = [];
  private IngresosObject: IngresosModel;
  ...
  private handleError(error: any) {
    ...
    */
  getIngresosList(): Observable<IngresosModel> {
    const url = `${this.apiurl}/GetAll/`;
    return this.http
      .get<IngresosModel>(url)
      .pipe(
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getIngresosListFull(): Observable<IngresosModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getIngresosListRelation(): Observable<IngresosModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getIngresos(id: number): Observable<IngresosModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  deleteIngresos(id: number): Observable<IngresosModel> {

    var IngresosObject = new IngresosModel(id,'',0,0,'',0,'',0,'',0,'',0,'','',
    ...
    return this.http
      .post<IngresosModel>(url, JSON.stringify(IngresosObject),this.httpOptions)
      .pipe(
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  addIngresos(Ingresos: IngresosModel): Observable<IngresosModel> {
    Ingresos.id = 0;
    Ingresos.auditoria ="{'RolBase':'"+localStorage.getItem("RolBase")+"'},"+
    ...
    Ingresos._usuario=localStorage.getItem('NombreUsuario');
    Ingresos._accion="Adicionar";
    Ingresos._ippublica=localStorage.getItem('IpPublica');
    Ingresos._browser=localStorage.getItem("Browser");
    Ingresos._nombremaquina=localStorage.getItem("NombreMaquina");
    Ingresos._sessionid=localStorage.getItem("Ubicacion");

    const url = `${this.apiurl}/Post/`;
    return this.http
      .post<IngresosModel>(url, JSON.stringify(Ingresos),this.httpOptions)
      .pipe(
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  updateIngresos(Ingresos: IngresosModel): Observable<IngresosModel> {
    Ingresos.auditoria ="{'RolBase':'"+localStorage.getItem("RolBase")+"'},"+
    "{'RolPersonalizado':'"+          localStorage.getItem("RolPersonalizado")+"'},"+
    "{'NombreUsuario':'"+        localStorage.getItem("NombreUsuario")+"'},"+
    "{'Ubicacion':'"+    localStorage.getItem("Ubicacion")+"'},"+
    ...
    return this.http
      .put<IngresosModel>(url, JSON.stringify(Ingresos),this.httpOptions)
      .pipe(
