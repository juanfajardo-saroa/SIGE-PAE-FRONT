 ...
 * Ano			    :2022
 * 
 * Arquitectura	    :Modelo Base de Angular para Arquitectura Microservicios de la Entidad Menus
 * 
...
/**
 *  decorador injectable indica que esta clase Menus puede ser inyectada dinamicamente
 *
 *  
 */
...
export class MenusService {
  ...
  private apiurl = environment.baseUrlAPI_AlimentosMenu + "Menus";
  private filterArray: MenusModel[] = [];
  private Menus: MenusModel[] = [];
  private MenusList: MenusModel[] = [];
  private MenusObject: MenusModel;
  ...
  private handleError(error: any) {
    ...
    */
  getMenusList(): Observable<MenusModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getMenusListFull(): Observable<MenusModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getMenusListRelation(): Observable<MenusModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getMenus(id: number): Observable<MenusModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  deleteMenus(id: number): Observable<MenusModel> {

    var MenusObject = new MenusModel(id,0,'',0,'',0,'',0,0,0,'',
    ...
    return this.http
      .post<MenusModel>(url, JSON.stringify(MenusObject),this.httpOptions)
      .pipe(
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  addMenus(Menus: MenusModel): Observable<MenusModel> {
    Menus.id = 0;
    Menus.auditoria ="{'RolBase':'"+localStorage.getItem("RolBase")+"'},"+
    ...
    Menus._usuario=localStorage.getItem('NombreUsuario');
    Menus._accion="Adicionar";
    Menus._ippublica=localStorage.getItem('IpPublica');
    Menus._browser=localStorage.getItem("Browser");
    Menus._nombremaquina=localStorage.getItem("NombreMaquina");
    Menus._sessionid=localStorage.getItem("Ubicacion");

    const url = `${this.apiurl}/Post/`;
    return this.http
      .post<MenusModel>(url, JSON.stringify(Menus),this.httpOptions)
      .pipe(
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  updateMenus(Menus: MenusModel): Observable<MenusModel> {
    Menus.auditoria ="{'RolBase':'"+localStorage.getItem("RolBase")+"'},"+
    "{'RolPersonalizado':'"+          localStorage.getItem("RolPersonalizado")+"'},"+
    "{'NombreUsuario':'"+        localStorage.getItem("NombreUsuario")+"'},"+
    "{'Ubicacion':'"+    localStorage.getItem("Ubicacion")+"'},"+
    ...
    return this.http
      .put<MenusModel>(url, JSON.stringify(Menus),this.httpOptions)
      .pipe(
