 ...
 * Ano			    :2022
 * 
 * Arquitectura	    :Modelo Base de Angular para Arquitectura Microservicios de la Entidad Roles
 * 
...
/**
 *  decorador injectable indica que esta clase Roles puede ser inyectada dinamicamente
 *
 *  
 */
...
export class RolesService {
  ...
  private apiurl = environment.baseUrlAPI_Seguridad + "Roles";
  private filterArray: RolesModel[] = [];
  private Roles: RolesModel[] = [];
  private RolesList: RolesModel[] = [];
  private RolesObject: RolesModel;
  ...
  private handleError(error: any) {
    ...
    */
  getRolesList(): Observable<RolesModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getRolesListFull(): Observable<RolesModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getRolesListRelation(): Observable<RolesModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getRoles(id: number): Observable<RolesModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  deleteRoles(id: number): Observable<RolesModel> {

    var RolesObject = new RolesModel(id,'','',
    ...
    return this.http
      .post<RolesModel>(url, JSON.stringify(RolesObject),this.httpOptions)
      .pipe(
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  addRoles(Roles: RolesModel): Observable<RolesModel> {
    Roles.id = 0;
    Roles.auditoria ="{'RolBase':'"+localStorage.getItem("RolBase")+"'},"+
    ...
    Roles._usuario=localStorage.getItem('NombreUsuario');
    Roles._accion="Adicionar";
    Roles._ippublica=localStorage.getItem('IpPublica');
    Roles._browser=localStorage.getItem("Browser");
    Roles._nombremaquina=localStorage.getItem("NombreMaquina");
    Roles._sessionid=localStorage.getItem("Ubicacion");

    const url = `${this.apiurl}/Post/`;
    return this.http
      .post<RolesModel>(url, JSON.stringify(Roles),this.httpOptions)
      .pipe(
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  updateRoles(Roles: RolesModel): Observable<RolesModel> {
    Roles.auditoria ="{'RolBase':'"+localStorage.getItem("RolBase")+"'},"+
    "{'RolPersonalizado':'"+          localStorage.getItem("RolPersonalizado")+"'},"+
    "{'NombreUsuario':'"+        localStorage.getItem("NombreUsuario")+"'},"+
    "{'Ubicacion':'"+    localStorage.getItem("Ubicacion")+"'},"+
    ...
    return this.http
      .put<RolesModel>(url, JSON.stringify(Roles),this.httpOptions)
      .pipe(
