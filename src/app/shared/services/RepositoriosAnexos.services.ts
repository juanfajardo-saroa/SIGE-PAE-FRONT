...
import { RepositoriosAnexosModel } from "../model/RepositoriosAnexos";
/**
 ...
 *  
 */
export class RepositoriosAnexosService {
  constructor(public http: HttpClient,public messageService:MessageService) {}

  // Definición de Variables requeridas
  public apiurl = environment.baseUrlAPI_ModuloUApa + "AnexoRecurso";
  public filterArray: RepositoriosAnexosModel[] = [];
  public apiurlFile = environment.baseUrlAPI_ModuloUApa + "File";
  public Repositorios: RepositoriosAnexosModel[] = [];
  public RepositoriosList: RepositoriosAnexosModel[] = [];
  private RepositoriosObject: RepositoriosAnexosModel;
  ...
  public handleError(error: any) {
    ...
    */
  getRepositoriosAnexosList(): Observable<RepositoriosAnexosModel> {
    const url = `${this.apiurl}/GetAll/`;
    return this.http
      .get<RepositoriosAnexosModel>(url)
      .pipe(
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getRepositoriosAnexosListFull(): Observable<RepositoriosAnexosModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getRepositoriosAnexosListRelation(): Observable<RepositoriosAnexosModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getRepositoriosAnexos(id: number): Observable<RepositoriosAnexosModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  deleteRepositoriosAnexos(id: number,nombre:string,archivo:string): Observable<RepositoriosAnexosModel> {

    var RepositoriosObject = new RepositoriosAnexosModel(id,0,archivo,nombre,'','',new Date(),[],'','',false,false,false,'','',
    ...
    return this.http
      .post<RepositoriosAnexosModel>(url, JSON.stringify(RepositoriosObject),this.httpOptions)
      .pipe(
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  addRepositoriosAnexos(Repositorios: RepositoriosAnexosModel): Observable<RepositoriosAnexosModel> {
    Repositorios.id = 0;
    ...
    return this.http
      .post<RepositoriosAnexosModel>(url, JSON.stringify(Repositorios),this.httpOptions)
      .pipe(
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  updateRepositoriosAnexos(Repositorios: RepositoriosAnexosModel): Observable<RepositoriosAnexosModel> {
    Repositorios.auditoria ="{'RolBase':'"+localStorage.getItem("RolBase")+"'},"+
    "{'RolPersonalizado':'"+          localStorage.getItem("RolPersonalizado")+"'},"+
    "{'NombreUsuario':'"+        localStorage.getItem("NombreUsuario")+"'},"+
    "{'Ubicacion':'"+    localStorage.getItem("Ubicacion")+"'},"+
    ...
    return this.http
      .put<RepositoriosAnexosModel>(url, JSON.stringify(Repositorios),this.httpOptions)
      .pipe(
