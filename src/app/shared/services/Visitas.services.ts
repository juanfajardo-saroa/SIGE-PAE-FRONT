...
/**
 *  decorador injectable indica que esta clase Visitas puede ser inyectada dinamicamente
 *
 *  
 */
 ...
 *  
 */
import { VisitasModel } from "../model/Visitas";
...
export class VisitasService {
  ...
  private apiurl = environment.baseUrlAPI_Seguimiento + "Visitas";
  private filterArray: VisitasModel[] = [];
  private Visitas: VisitasModel[] = [];
  private VisitasList: VisitasModel[] = [];
  private VisitasObject: VisitasModel;
  ...
  private handleError(error: any) {
    ...
    */
  getVisitasList(): Observable<VisitasModel> {
    const url = `${this.apiurl}/GetAll/`;
    return this.http
      .get<VisitasModel>(url)
      .pipe(
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getVisitasListFull(): Observable<VisitasModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getVisitasListRelation(): Observable<VisitasModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getVisitas(id: number): Observable<VisitasModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  deleteVisitas(id: number): Observable<VisitasModel> {

    var VisitasObject = new VisitasModel(id,0,'',0,'',0,'',0,'',0,'',0,'',0,'',new Date(),new Date(),new Date(),'',
    ...
    return this.http
      .post<VisitasModel>(url, JSON.stringify(VisitasObject),this.httpOptions)
      .pipe(
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  addVisitas(Visitas: VisitasModel): Observable<VisitasModel> {
    Visitas.id = 0;
    Visitas.auditoria ="{'RolBase':'"+localStorage.getItem("RolBase")+"'},"+
    ...
    Visitas._usuario=localStorage.getItem('NombreUsuario');
    Visitas._accion="Adicionar";
    Visitas._ippublica=localStorage.getItem('IpPublica');
    Visitas._browser=localStorage.getItem("Browser");
    Visitas._nombremaquina=localStorage.getItem("NombreMaquina");
    Visitas._sessionid=localStorage.getItem("Ubicacion");

    const url = `${this.apiurl}/Post/`;
    return this.http
      .post<VisitasModel>(url, JSON.stringify(Visitas),this.httpOptions)
      .pipe(
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  updateVisitas(Visitas: VisitasModel): Observable<VisitasModel> {
    Visitas.auditoria ="{'RolBase':'"+localStorage.getItem("RolBase")+"'},"+
    "{'RolPersonalizado':'"+          localStorage.getItem("RolPersonalizado")+"'},"+
    "{'NombreUsuario':'"+        localStorage.getItem("NombreUsuario")+"'},"+
    "{'Ubicacion':'"+    localStorage.getItem("Ubicacion")+"'},"+
    ...
    return this.http
      .put<VisitasModel>(url, JSON.stringify(Visitas),this.httpOptions)
      .pipe(
