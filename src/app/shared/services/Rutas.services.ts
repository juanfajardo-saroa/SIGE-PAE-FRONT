 ...
 * Ano			    :2022
 * 
 * Arquitectura	    :Modelo Base de Angular para Arquitectura Microservicios de la Entidad Rutas
 * 
...
/**
 *  decorador injectable indica que esta clase Rutas puede ser inyectada dinamicamente
 *
 *  
 */
 ...
 *  
 */
import { RutasModel } from "../model/Rutas";
...
export class RutasService {
  ...
  private apiurl = environment.baseUrlAPI_PlanAlistamiento + "Rutas";
  private filterArray: RutasModel[] = [];
  private Rutas: RutasModel[] = [];
  private RutasList: RutasModel[] = [];
  private RutasObject: RutasModel;
  ...
  private handleError(error: any) {
    ...
    */
  getRutasList(): Observable<RutasModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getRutasListFull(): Observable<RutasModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getRutasListRelation(): Observable<RutasModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getRutas(id: number): Observable<RutasModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  deleteRutas(id: number): Observable<RutasModel> {

    var RutasObject = new RutasModel(id,0,'',0,'',0,'','',
    ...
    return this.http
      .post<RutasModel>(url, JSON.stringify(RutasObject),this.httpOptions)
      .pipe(
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  addRutas(Rutas: RutasModel): Observable<RutasModel> {
    Rutas.id = 0;
    Rutas.auditoria ="{'RolBase':'"+localStorage.getItem("RolBase")+"'},"+
    ...
    Rutas._usuario=localStorage.getItem('NombreUsuario');
    Rutas._accion="Adicionar";
    Rutas._ippublica=localStorage.getItem('IpPublica');
    Rutas._browser=localStorage.getItem("Browser");
    Rutas._nombremaquina=localStorage.getItem("NombreMaquina");
    Rutas._sessionid=localStorage.getItem("Ubicacion");

    const url = `${this.apiurl}/Post/`;
    return this.http
      .post<RutasModel>(url, JSON.stringify(Rutas),this.httpOptions)
      .pipe(
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  updateRutas(Rutas: RutasModel): Observable<RutasModel> {
    Rutas.auditoria ="{'RolBase':'"+localStorage.getItem("RolBase")+"'},"+
    "{'RolPersonalizado':'"+          localStorage.getItem("RolPersonalizado")+"'},"+
    "{'NombreUsuario':'"+        localStorage.getItem("NombreUsuario")+"'},"+
    "{'Ubicacion':'"+    localStorage.getItem("Ubicacion")+"'},"+
    ...
    return this.http
      .put<RutasModel>(url, JSON.stringify(Rutas),this.httpOptions)
      .pipe(
