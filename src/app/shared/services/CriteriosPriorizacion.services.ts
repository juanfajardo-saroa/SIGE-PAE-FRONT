 ...
 * Ano			    :2022
 * 
 * Arquitectura	    :Modelo Base de Angular para Arquitectura Microservicios de la Entidad CriteriosPriorizacion
 * 
...
export class CriteriosPriorizacionService {
  ...
  private CriteriosPriorizacionObject: CriteriosPriorizacionModel;
  ...
  getCriteriosPriorizacion(id: number): Observable<CriteriosPriorizacionModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  deleteCriteriosPriorizacion(id: number): Observable<CriteriosPriorizacionModel> {

    var CriteriosPriorizacionObject = new CriteriosPriorizacionModel(id,0,'',false,'',
    ...
    return this.http
      .post<CriteriosPriorizacionModel>(url, JSON.stringify(CriteriosPriorizacionObject),this.httpOptions)
      .pipe(
  ...
  addCriteriosPriorizacion(CriteriosPriorizacion: CriteriosPriorizacionModel): Observable<CriteriosPriorizacionModel> {
    ...
    CriteriosPriorizacion._usuario=localStorage.getItem('NombreUsuario');
    CriteriosPriorizacion._accion="Adicionar";
    CriteriosPriorizacion._ippublica=localStorage.getItem('IpPublica');
    CriteriosPriorizacion._browser=localStorage.getItem("Browser");
    CriteriosPriorizacion._nombremaquina=localStorage.getItem("NombreMaquina");
    CriteriosPriorizacion._sessionid=localStorage.getItem("Ubicacion");
  ...
  updateCriteriosPriorizacion(CriteriosPriorizacion: CriteriosPriorizacionModel): Observable<CriteriosPriorizacionModel> {
    ...
    "{'NombreMaquina':'"+        localStorage.getItem("NombreMaquina")+"'}";
    CriteriosPriorizacion._usuario=localStorage.getItem('NombreUsuario');
    CriteriosPriorizacion._accion="Actuializar";
    CriteriosPriorizacion._ippublica=localStorage.getItem('IpPublica');
    CriteriosPriorizacion._browser=localStorage.getItem("Browser");
    CriteriosPriorizacion._nombremaquina=localStorage.getItem("NombreMaquina");
    CriteriosPriorizacion._sessionid=localStorage.getItem("Ubicacion");
