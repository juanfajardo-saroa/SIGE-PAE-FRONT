 ...
 * Ano			    :2022
 *
 * Arquitectura	    :Modelo Base de Angular para Arquitectura Microservicios de la Entidad Users
 *
...
/**
 *  decorador injectable indica que esta clase Users puede ser inyectada dinamicamente
 *
 *
 */
...
export class UsersService {
  ...
  private apiurl = environment.baseUrlAPI_Seguridad + "Users";
  private filterArray: UsersModel[] = [];
  private Users: UsersModel[] = [];
  private UsersList: UsersModel[] = [];
  private UsersObject: UsersModel;
  ...
  getUsersList(): Observable<UsersModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getUsersListFull(): Observable<UsersModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getUsersListRelation(): Observable<UsersModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getUsers(id: number): Observable<UsersModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  deleteUsers(id: number): Observable<UsersModel> {

    var UsersObject = new UsersModel(id,'','','','','',
    ...
    return this.http
      .post<UsersModel>(url, JSON.stringify(UsersObject),this.httpOptions)
      .pipe(
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  addUsers(Users: UsersModel): Observable<UsersModel> {
    Users.id = 0;
    Users.auditoria ="{'RolBase':'"+localStorage.getItem("RolBase")+"'},"+
    ...
    Users._usuario=localStorage.getItem('NombreUsuario');
    Users._accion="Adicionar";
    Users._ippublica=localStorage.getItem('IpPublica');
    Users._browser=localStorage.getItem("Browser");
    Users._nombremaquina=localStorage.getItem("NombreMaquina");
    Users._sessionid=localStorage.getItem("Ubicacion");

    const url = `${this.apiurl}/Post/`;
    return this.http
      .post<UsersModel>(url, JSON.stringify(Users),this.httpOptions)
      .pipe(
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  updateUsers(Users: UsersModel): Observable<UsersModel> {
    Users.auditoria ="{'RolBase':'"+localStorage.getItem("RolBase")+"'},"+
    "{'RolPersonalizado':'"+          localStorage.getItem("RolPersonalizado")+"'},"+
    "{'NombreUsuario':'"+        localStorage.getItem("NombreUsuario")+"'},"+
    "{'Ubicacion':'"+    localStorage.getItem("Ubicacion")+"'},"+
    ...
    return this.http
      .put<UsersModel>(url, JSON.stringify(Users),this.httpOptions)
      .pipe(
