 ...
 * Ano			    :2022
 * 
 * Arquitectura	    :Modelo Base de Angular para Arquitectura Microservicios de la Entidad Zonas
 * 
...
/**
 *  decorador injectable indica que esta clase Zonas puede ser inyectada dinamicamente
 *
 *  
 */
 ...
 *  
 */
import { ZonasModel } from "../model/Zonas";
...
export class ZonasService {
  ...
  private apiurl = environment.baseUrlAPI_SistemaEducativo + "Zonas";
  private filterArray: ZonasModel[] = [];
  private Zonas: ZonasModel[] = [];
  private ZonasList: ZonasModel[] = [];
  private ZonasObject: ZonasModel;
  ...
  private handleError(error: any) {
    ...
    */
  getZonasList(): Observable<ZonasModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getZonasListFull(): Observable<ZonasModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getZonasListRelation(): Observable<ZonasModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getZonas(id: number): Observable<ZonasModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  deleteZonas(id: number): Observable<ZonasModel> {

    var ZonasObject = new ZonasModel(id,'','',
    ...
    return this.http
      .post<ZonasModel>(url, JSON.stringify(ZonasObject),this.httpOptions)
      .pipe(
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  addZonas(Zonas: ZonasModel): Observable<ZonasModel> {
    Zonas.id = 0;
    Zonas.auditoria ="{'RolBase':'"+localStorage.getItem("RolBase")+"'},"+
    ...
    Zonas._usuario=localStorage.getItem('NombreUsuario');
    Zonas._accion="Adicionar";
    Zonas._ippublica=localStorage.getItem('IpPublica');
    Zonas._browser=localStorage.getItem("Browser");
    Zonas._nombremaquina=localStorage.getItem("NombreMaquina");
    Zonas._sessionid=localStorage.getItem("Ubicacion");

    const url = `${this.apiurl}/Post/`;
    return this.http
      .post<ZonasModel>(url, JSON.stringify(Zonas),this.httpOptions)
      .pipe(
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  updateZonas(Zonas: ZonasModel): Observable<ZonasModel> {
    Zonas.auditoria ="{'RolBase':'"+localStorage.getItem("RolBase")+"'},"+
    "{'RolPersonalizado':'"+          localStorage.getItem("RolPersonalizado")+"'},"+
    "{'NombreUsuario':'"+        localStorage.getItem("NombreUsuario")+"'},"+
    "{'Ubicacion':'"+    localStorage.getItem("Ubicacion")+"'},"+
    ...
    return this.http
      .put<ZonasModel>(url, JSON.stringify(Zonas),this.httpOptions)
      .pipe(
