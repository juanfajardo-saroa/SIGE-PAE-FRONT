 ...
 * Ano			    :2022
 * 
 * Arquitectura	    :Modelo Base de Angular para Arquitectura Microservicios de la Entidad Comite
 * 
...
/**
 *  decorador injectable indica que esta clase Comite puede ser inyectada dinamicamente
 *
 *  
 */
 ...
 *  
 */
import { ComiteModel } from "../model/Comite";
...
export class ComiteService {
  ...
  private apiurl = environment.baseUrlAPI_GestionExcedentes + "Comite";
  private filterArray: ComiteModel[] = [];
  private Comite: ComiteModel[] = [];
  private ComiteList: ComiteModel[] = [];
  private ComiteObject: ComiteModel;
  ...
  private handleError(error: any) {
    ...
    */
  getComiteList(): Observable<ComiteModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getComiteListFull(): Observable<ComiteModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getComiteListRelation(): Observable<ComiteModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getComite(id: number): Observable<ComiteModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  deleteComite(id: number): Observable<ComiteModel> {

    var ComiteObject = new ComiteModel(id,0,'',0,'','',new Date(),0,0,0,'',
    ...
    return this.http
      .post<ComiteModel>(url, JSON.stringify(ComiteObject),this.httpOptions)
      .pipe(
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  addComite(Comite: ComiteModel): Observable<ComiteModel> {
    Comite.id = 0;
    Comite.auditoria ="{'RolBase':'"+localStorage.getItem("RolBase")+"'},"+
    ...
    Comite._usuario=localStorage.getItem('NombreUsuario');
    Comite._accion="Adicionar";
    Comite._ippublica=localStorage.getItem('IpPublica');
    Comite._browser=localStorage.getItem("Browser");
    Comite._nombremaquina=localStorage.getItem("NombreMaquina");
    Comite._sessionid=localStorage.getItem("Ubicacion");

    const url = `${this.apiurl}/Post/`;
    return this.http
      .post<ComiteModel>(url, JSON.stringify(Comite),this.httpOptions)
      .pipe(
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  updateComite(Comite: ComiteModel): Observable<ComiteModel> {
    Comite.auditoria ="{'RolBase':'"+localStorage.getItem("RolBase")+"'},"+
    "{'RolPersonalizado':'"+          localStorage.getItem("RolPersonalizado")+"'},"+
    "{'NombreUsuario':'"+        localStorage.getItem("NombreUsuario")+"'},"+
    "{'Ubicacion':'"+    localStorage.getItem("Ubicacion")+"'},"+
    ...
    return this.http
      .put<ComiteModel>(url, JSON.stringify(Comite),this.httpOptions)
      .pipe(
