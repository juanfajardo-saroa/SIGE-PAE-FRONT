 ...
 *  
 */
import { PagosModel } from "../model/Pagos";
...
export class PagosService {
  ...
  private apiurl = environment.baseUrlAPI_PlaneacionFinanciera + "Pagos";
  private filterArray: PagosModel[] = [];
  private Pagos: PagosModel[] = [];
  private PagosList: PagosModel[] = [];
  private PagosObject: PagosModel;
  ...
  private handleError(error: any) {
    ...
    */
  getPagosList(): Observable<PagosModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getPagosListFull(): Observable<PagosModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getPagosListRelation(): Observable<PagosModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getPagos(id: number): Observable<PagosModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  deletePagos(id: number): Observable<PagosModel> {

    var PagosObject = new PagosModel(id,0,'',new Date(),'',0,'',new Date(),0,'','',
    ...
    return this.http
      .post<PagosModel>(url, JSON.stringify(PagosObject),this.httpOptions)
      .pipe(
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  addPagos(Pagos: PagosModel): Observable<PagosModel> {
    Pagos.id = 0;
    Pagos.auditoria ="{'RolBase':'"+localStorage.getItem("RolBase")+"'},"+
    ...
    Pagos._usuario=localStorage.getItem('NombreUsuario');
    Pagos._accion="Adicionar";
    Pagos._ippublica=localStorage.getItem('IpPublica');
    Pagos._browser=localStorage.getItem("Browser");
    Pagos._nombremaquina=localStorage.getItem("NombreMaquina");
    Pagos._sessionid=localStorage.getItem("Ubicacion");

    const url = `${this.apiurl}/Post/`;
    return this.http
      .post<PagosModel>(url, JSON.stringify(Pagos),this.httpOptions)
      .pipe(
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  updatePagos(Pagos: PagosModel): Observable<PagosModel> {
    Pagos.auditoria ="{'RolBase':'"+localStorage.getItem("RolBase")+"'},"+
    "{'RolPersonalizado':'"+          localStorage.getItem("RolPersonalizado")+"'},"+
    "{'NombreUsuario':'"+        localStorage.getItem("NombreUsuario")+"'},"+
    "{'Ubicacion':'"+    localStorage.getItem("Ubicacion")+"'},"+
    ...
    return this.http
      .put<PagosModel>(url, JSON.stringify(Pagos),this.httpOptions)
      .pipe(
