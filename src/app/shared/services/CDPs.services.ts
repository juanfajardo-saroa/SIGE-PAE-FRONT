 ...
 * Ano			    :2022
 * 
 * Arquitectura	    :Modelo Base de Angular para Arquitectura Microservicios de la Entidad CDPs
 * 
...
/**
 *  decorador injectable indica que esta clase CDPs puede ser inyectada dinamicamente
 *
 *  
 */
 ...
 *  
 */
import { CDPsModel } from "../model/CDPs";
...
export class CDPsService {
  ...
  private apiurl = environment.baseUrlAPI_PlaneacionFinanciera + "CDPs";
  private filterArray: CDPsModel[] = [];
  private CDPs: CDPsModel[] = [];
  private CDPsList: CDPsModel[] = [];
  private CDPsObject: CDPsModel;
  ...
  private handleError(error: any) {
    ...
    */
  getCDPsList(): Observable<CDPsModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getCDPsListFull(): Observable<CDPsModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getCDPsListRelation(): Observable<CDPsModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getCDPs(id: number): Observable<CDPsModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  deleteCDPs(id: number): Observable<CDPsModel> {

    var CDPsObject = new CDPsModel(id,0,'',0,0,0,'',
    ...
    return this.http
      .post<CDPsModel>(url, JSON.stringify(CDPsObject),this.httpOptions)
      .pipe(
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  addCDPs(CDPs: CDPsModel): Observable<CDPsModel> {
    CDPs.id = 0;
    CDPs.auditoria ="{'RolBase':'"+localStorage.getItem("RolBase")+"'},"+
    ...
    CDPs._usuario=localStorage.getItem('NombreUsuario');
    CDPs._accion="Adicionar";
    CDPs._ippublica=localStorage.getItem('IpPublica');
    CDPs._browser=localStorage.getItem("Browser");
    CDPs._nombremaquina=localStorage.getItem("NombreMaquina");
    CDPs._sessionid=localStorage.getItem("Ubicacion");

    const url = `${this.apiurl}/Post/`;
    return this.http
      .post<CDPsModel>(url, JSON.stringify(CDPs),this.httpOptions)
      .pipe(
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  updateCDPs(CDPs: CDPsModel): Observable<CDPsModel> {
    CDPs.auditoria ="{'RolBase':'"+localStorage.getItem("RolBase")+"'},"+
    "{'RolPersonalizado':'"+          localStorage.getItem("RolPersonalizado")+"'},"+
    "{'NombreUsuario':'"+        localStorage.getItem("NombreUsuario")+"'},"+
    "{'Ubicacion':'"+    localStorage.getItem("Ubicacion")+"'},"+
    ...
    return this.http
      .put<CDPsModel>(url, JSON.stringify(CDPs),this.httpOptions)
      .pipe(
