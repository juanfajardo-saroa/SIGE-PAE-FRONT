...
/**
 *  decorador injectable indica que esta clase Sedes puede ser inyectada dinamicamente
 *
 *
 */
  ...
  *
  */
 import { SedesModel } from "../model/Sedes";
 ...
 export class SedesService {
   ...
   public apiurl = environment.baseUrlAPI_SistemaEducativo + "Sedes";
   public filterArray: SedesModel[] = [];
   public Sedes: SedesModel[] = [];
   public SedesList: SedesModel[] = [];
   private SedesObject: SedesModel;
   ...
   getSedesListFullfilter(idEtc: number): Observable<SedesModel> {
    const url = `${this.apiurl}/GetAllFull?%24filter=iD_ETC%20eq%20${idEtc}`;
    return this.http
      .get<SedesModel>(url)
      .pipe(
        tap(),   // para poder realizar efectos secundrios
   ...
   getSedesListRelationFilter(idEtc: number): Observable<SedesModel> {
  ...
  getSedesListRelationFilter2(idEtc: number,id_divipola:number, id_ie:number): Observable<SedesModel> {
    const url = `${this.apiurl}/GetAll?%24filter=iD_ETC%20eq%20${idEtc}%20and%20iD_Divipola%20eq%20${id_divipola}%20and%20iD_lE%20eq%20${id_ie}`;
    return this.http
      .get<SedesModel>(url)
      .pipe(
        tap(),   // para poder realizar efectos secundrios
  ...
  getSedesListRelationFilter3(id_ie:number): Observable<SedesModel> {
    const url = `${this.apiurl}/GetAllRelation?%24filter=iD_lE%20eq%20${id_ie}`;
    return this.http
      .get<SedesModel>(url)
      .pipe(
        tap(),   // para poder realizar efectos secundrios
  ...
  getSedesListRelationFilter3_1(id_ie:number): Observable<SedesModel> {
    const url = `${this.apiurl}/GetAll?%24filter=iD_lE%20eq%20${id_ie}`;
    return this.http
      .get<SedesModel>(url)
      .pipe(
        tap(),   // para poder realizar efectos secundrios
  ...
  getSedesListRelationFilter4(id:number): Observable<SedesModel> {
  ...
  getSedesListRelationFilter5(idEtc: number,id_divipola:number): Observable<SedesModel> {
    const url = `${this.apiurl}/GetAll?%24filter=iD_ETC%20eq%20${idEtc}%20and%20iD_Divipola%20eq%20${id_divipola}`;
    return this.http
      .get<SedesModel>(url)
      .pipe(
        tap(),   // para poder realizar efectos secundrios
   ...
   deleteSedes(id: number): Observable<SedesModel> {
     ...
     var SedesObject = new SedesModel(id,0,'',0,'',0,'',0,'',0,'','','','','',false,false,'','',0,
     ...
     return this.http
       .post<SedesModel>(url, JSON.stringify(SedesObject),this.httpOptions)
       .pipe(
   ...
   addSedes(Sedes: SedesModel): Observable<SedesModel> {
     Sedes.id = 0;
     Sedes.auditoria ="{'RolBase':'"+localStorage.getItem("RolBase")+"'},"+
     ...
     Sedes._usuario=localStorage.getItem('NombreUsuario');
     Sedes._accion="Adicionar";
     Sedes._ippublica=localStorage.getItem('IpPublica');
     Sedes._browser=localStorage.getItem("Browser");
     Sedes._nombremaquina=localStorage.getItem("NombreMaquina");
     Sedes._sessionid=localStorage.getItem("Ubicacion");
     ...
     *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
     */
   updateSedes(Sedes: SedesModel): Observable<SedesModel> {
     Sedes.auditoria ="{'RolBase':'"+localStorage.getItem("RolBase")+"'},"+
     "{'RolPersonalizado':'"+          localStorage.getItem("RolPersonalizado")+"'},"+
     "{'NombreUsuario':'"+        localStorage.getItem("NombreUsuario")+"'},"+
     "{'Ubicacion':'"+    localStorage.getItem("Ubicacion")+"'},"+
