 ...
 * Ano			    :2022
 * 
 * Arquitectura	    :Modelo Base de Angular para Arquitectura Microservicios de la Entidad Semanas
 * 
...
/**
 *  decorador injectable indica que esta clase Semanas puede ser inyectada dinamicamente
 *
 *  
 */
 ...
 *  
 */
import { SemanasModel } from "../model/Semanas";
...
export class SemanasService {
  ...
  private apiurl = environment.baseUrlAPI_PlanAlistamiento + "Semanas";
  private filterArray: SemanasModel[] = [];
  private Semanas: SemanasModel[] = [];
  private SemanasList: SemanasModel[] = [];
  private SemanasObject: SemanasModel;
  ...
  private handleError(error: any) {
    ...
    */
  getSemanasList(): Observable<SemanasModel> {
    const url = `${this.apiurl}/GetAll/`;
    return this.http
      .get<SemanasModel>(url)
      .pipe(
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getSemanasListFull(): Observable<SemanasModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getSemanasListRelation(): Observable<SemanasModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getSemanas(id: number): Observable<SemanasModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  deleteSemanas(id: number): Observable<SemanasModel> {

    var SemanasObject = new SemanasModel(id,0,'',0,'',0,'',
    ...
    return this.http
      .post<SemanasModel>(url, JSON.stringify(SemanasObject),this.httpOptions)
      .pipe(
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  addSemanas(Semanas: SemanasModel): Observable<SemanasModel> {
    Semanas.id = 0;
    Semanas.auditoria ="{'RolBase':'"+localStorage.getItem("RolBase")+"'},"+
    ...
    Semanas._usuario=localStorage.getItem('NombreUsuario');
    Semanas._accion="Adicionar";
    Semanas._ippublica=localStorage.getItem('IpPublica');
    Semanas._browser=localStorage.getItem("Browser");
    Semanas._nombremaquina=localStorage.getItem("NombreMaquina");
    Semanas._sessionid=localStorage.getItem("Ubicacion");

    const url = `${this.apiurl}/Post/`;
    return this.http
      .post<SemanasModel>(url, JSON.stringify(Semanas),this.httpOptions)
      .pipe(
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  updateSemanas(Semanas: SemanasModel): Observable<SemanasModel> {
    Semanas.auditoria ="{'RolBase':'"+localStorage.getItem("RolBase")+"'},"+
    "{'RolPersonalizado':'"+          localStorage.getItem("RolPersonalizado")+"'},"+
    "{'NombreUsuario':'"+        localStorage.getItem("NombreUsuario")+"'},"+
    "{'Ubicacion':'"+    localStorage.getItem("Ubicacion")+"'},"+
    ...
    return this.http
      .put<SemanasModel>(url, JSON.stringify(Semanas),this.httpOptions)
      .pipe(
