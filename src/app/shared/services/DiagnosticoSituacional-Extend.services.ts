...
import { DiagnosticoSituacionalExtendModel } from './../model/DiagnosticoSituacional-Extend';
...
export class DiagnosticoSituacionalExtendService extends DiagnosticoSituacionalService{
  ...
  httpOptions1 = {
   ...
   addRepositoriosE(Repositorios:  DiagnosticoSituacionalExtendModel): Observable<DiagnosticoSituacionalExtendModel> {
    Repositorios.id = 0;
    Repositorios.auditoria = "";
    const url = `${this.apiurl}/Post/`;
    return this.http
      .post<DiagnosticoSituacionalExtendModel>(url, JSON.stringify(Repositorios),this.httpOptions1)
      .pipe(
