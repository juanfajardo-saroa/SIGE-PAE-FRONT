 ...
 * Ano			    :2022
 * 
 * Arquitectura	    :Modelo Base de Angular para Arquitectura Microservicios de la Entidad PA_CicloMenuAporteNutricionalXAprobacion
 * 
...
/**
 *  decorador injectable indica que esta clase PA_CicloMenuAporteNutricionalXAprobacion puede ser inyectada dinamicamente
 *
 *  
 */
...
import { PA_CicloMenuAporteNutricionalXAprobacionModel } from "../model/PA_CicloMenuAporteNutricionalXAprobacionModel";
/**
 ...
 *  
 */
export class PA_CicloMenuAporteNutricionalXAprobacionService {
  constructor(private http: HttpClient,private messageService:MessageService) {}

  // Definición de Variables requeridas
  private apiurl = environment.baseUrlAPI_PTN + "PA_CicloMenuAporteNutricionalXAprobacion";
  private filterArray: PA_CicloMenuAporteNutricionalXAprobacionModel[] = [];
  private PA_CicloMenuAporteNutricionalXAprobacion: PA_CicloMenuAporteNutricionalXAprobacionModel[] = [];
  private PA_CicloMenuAporteNutricionalXAprobacionList: PA_CicloMenuAporteNutricionalXAprobacionModel[] = [];
  private PA_CicloMenuAporteNutricionalXAprobacionObject: PA_CicloMenuAporteNutricionalXAprobacionModel;
  ...
  private handleError(error: any) {
    ...
    */
 getPA_CicloMenuAporteNutricionalXAprobacionList(PA_CicloMenuAportesNutricionalesPiv: PA_CicloMenuAporteNutricionalXAprobacion): Observable<PA_CicloMenuAporteNutricionalXAprobacionModel> {
  ...
  params = PA_CicloMenuAportesNutricionalesPiv.ID_MinutaAprobacion ? params.append('ID_MinutaAprobacion', PA_CicloMenuAportesNutricionalesPiv.ID_MinutaAprobacion) : params;
  ...
  //const url = `${this.apiurl}/GetAll?ID_Etc=${ID_Etc}&ID_TipoModeloOperacion=${ID_TipoModeloOperacion}&ID_TipoComplemento=${ID_TipoComplemento}&ID_TipoModalidadComplemento=${ID_TipoModalidadComplemento}&ID_MinutaPatronAlimento=${ID_MinutaPatronAlimento}&ID_CiclosMenuReferencia=${ID_CiclosMenuReferencia}&ID_TipoNivelEducativo=${ID_TipoNivelEducativo}&ID_Zona=${ID_Zona}&ID_CicloMenu=${ID_CicloMenu}&ID_Preparacion=${ID_Preparacion}&ID_Semana=${ID_Semana}&Dia=${Dia}`;
    return this.http
      .get<PA_CicloMenuAporteNutricionalXAprobacionModel>(url, { params: params })
      .pipe(
