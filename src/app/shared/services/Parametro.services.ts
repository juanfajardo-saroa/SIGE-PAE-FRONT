 ...
 * Ano			    :2022
 * 
 * Arquitectura	    :Modelo Base de Angular para Arquitectura Microservicios de la Entidad Parametro
 * 
...
/**
 *  decorador injectable indica que esta clase Parametro puede ser inyectada dinamicamente
 *
 *  
 */
...
export class ParametroService {
  ...
  private apiurl = environment.baseUrlAPI_Configuracion + "Parametro";
  private filterArray: ParametroModel[] = [];
  private Parametro: ParametroModel[] = [];
  private ParametroList: ParametroModel[] = [];
  private ParametroObject: ParametroModel;
   ...
   */
  getParametroList(): Observable<ParametroModel> {
    const url = `${this.apiurl}/GetAll/`;
    return this.http
      .get<ParametroModel>(url)
      .pipe(
   ...
   *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
   */
  getParametroListFull(): Observable<ParametroModel> {
   ...
   *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
   */
  getParametroListRelation(): Observable<ParametroModel> {
   ...
   *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
   */
  getParametro(id: number): Observable<ParametroModel> {
   ...
   *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
   */
  deleteParametro(id: number, nombre: string): Observable<ParametroModel> {

    var ParametroObject = new ParametroModel(id, nombre, 0, '', '',
    ...
    return this.http
      .post<ParametroModel>(url, JSON.stringify(ParametroObject), this.httpOptions)
      .pipe(
   ...
   *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
   */
  addParametro(Parametro: ParametroModel): Observable<ParametroModel> {
    Parametro.id = 0;
    Parametro.auditoria = "{'RolBase':'" + localStorage.getItem("RolBase") + "'}," +
    ...
    Parametro._usuario = localStorage.getItem('KeyMaster');
    Parametro._accion = "Adicionar";
    Parametro._ippublica = localStorage.getItem('IpPublica');
    Parametro._browser = localStorage.getItem("Browser");
    Parametro._nombremaquina = localStorage.getItem("NombreUsuario");
    Parametro._sessionid = localStorage.getItem("NombreUsuario");

    const url = `${this.apiurl}/Post/`;
    return this.http
      .post<ParametroModel>(url, JSON.stringify(Parametro), this.httpOptions)
      .pipe(
   ...
   *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
   */
  updateParametro(Parametro: ParametroModel): Observable<ParametroModel> {
    Parametro.auditoria = "{'RolBase':'" + localStorage.getItem("RolBase") + "'}," +
      "{'RolPersonalizado':'" + localStorage.getItem("RolPersonalizado") + "'}," +
      "{'NombreUsuario':'" + localStorage.getItem("KeyMaster") + "'}," +
      "{'Ubicacion':'" + localStorage.getItem("Ubicacion") + "'}," +
    ...
    return this.http
      .put<ParametroModel>(url, JSON.stringify(Parametro), this.httpOptions)
      .pipe(
