...
export class PA_PrioSedeBeneficiariasService {
  ...
  public apiurl = environment.baseUrlAPI_Priorizacion + "PA_PrioSedeBeneficiarias";
  ...
  getPA_PrioSedeBeneficiariasList(): Observable<PA_PrioSedeBeneficiariasModel> {
    ...
    return this.http
      .get<PA_PrioSedeBeneficiariasModel>(url)
      .pipe(
