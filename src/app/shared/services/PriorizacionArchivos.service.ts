...
import { PriorizacionesService } from "./Priorizaciones.services";
import { fileUploadModel } from "../model/fileUpload";
import { PriorizacionArchivoExtendModel } from "../model/PriorizacionArchivos";
...
export class PriorizacionArchivosService extends PriorizacionesService{
  ...
  httpOptions1 = {
   ...
   addRepositoriosE(Repositorios: PriorizacionArchivoExtendModel): Observable<PriorizacionArchivoExtendModel> {
    Repositorios.id = 0;
   
    const url = `${this.apiurl}/Post/`;
    return this.http
      .post<PriorizacionArchivoExtendModel>(url, JSON.stringify(Repositorios),this.httpOptions1)
      .pipe(
  ...
  addFileBlobRepositorios(fileUpload:fileUploadModel){
    ...
    let urldef = url + "?cnx=" + fileUpload.cnx + "&fileName=" + fileUpload.fileName + "&Container=" + fileUpload.container
    return this.http
