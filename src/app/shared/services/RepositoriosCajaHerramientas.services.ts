...
import { RepositoriosCajaHerramientasModel } from "../model/RepositoriosCajaHerramientas";
/**
 ...
 *  
 */
export class RepositoriosCajaHerramientasService {
  constructor(public http: HttpClient,public messageService:MessageService) {}

  // Definición de Variables requeridas
  public apiurl = environment.baseUrlAPI_ModuloUApa + "CajaHerramienta";
  public filterArray: RepositoriosCajaHerramientasModel[] = [];
  public apiurlFile = environment.baseUrlAPI_ModuloUApa + "File";
  public Repositorios: RepositoriosCajaHerramientasModel[] = [];
  public RepositoriosList: RepositoriosCajaHerramientasModel[] = [];
  private RepositoriosObject: RepositoriosCajaHerramientasModel;
  ...
  public handleError(error: any) {
    ...
    */
  getRepositoriosCajaHerramientaList(): Observable<RepositoriosCajaHerramientasModel> {
    const url = `${this.apiurl}/GetAll/`;
    return this.http
      .get<RepositoriosCajaHerramientasModel>(url)
      .pipe(
...
/**
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getRepositoriosCajaHerramientaListfilter(idAnexos:number): Observable<RepositoriosCajaHerramientasModel> {
    const url = `${this.apiurl}/GetAll?%24filter=id_AnexoRecurso%20eq%20${idAnexos}`;
    return this.http
      .get<RepositoriosCajaHerramientasModel>(url)
      .pipe(
        tap(),   // para poder realizar efectos secundrios
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getRepositoriosCajaHerramientaListFull(): Observable<RepositoriosCajaHerramientasModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getRepositoriosCajaHerramientaListRelation(): Observable<RepositoriosCajaHerramientasModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getRepositoriosCajaHerramienta(id: number): Observable<RepositoriosCajaHerramientasModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  deleteRepositoriosCajaHerramienta(id: number,archivo:string): Observable<RepositoriosCajaHerramientasModel> {

    var RepositoriosObject = new RepositoriosCajaHerramientasModel(id,0,archivo,'','','',new Date(),'','',false,false,false,'','',
    ...
    return this.http
      .post<RepositoriosCajaHerramientasModel>(url, JSON.stringify(RepositoriosObject),this.httpOptions)
      .pipe(
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  addRepositoriosCajaHerramienta(Repositorios: RepositoriosCajaHerramientasModel): Observable<RepositoriosCajaHerramientasModel> {
    Repositorios.id = 0;
    ...
    return this.http
      .post<RepositoriosCajaHerramientasModel>(url, JSON.stringify(Repositorios),this.httpOptions)
      .pipe(
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  updateRepositoriosCajaHerramienta(Repositorios: RepositoriosCajaHerramientasModel): Observable<RepositoriosCajaHerramientasModel> {
    Repositorios.auditoria ="{'RolBase':'"+localStorage.getItem("RolBase")+"'},"+
    "{'RolPersonalizado':'"+          localStorage.getItem("RolPersonalizado")+"'},"+
    "{'NombreUsuario':'"+        localStorage.getItem("NombreUsuario")+"'},"+
    "{'Ubicacion':'"+    localStorage.getItem("Ubicacion")+"'},"+
    ...
    return this.http
      .put<RepositoriosCajaHerramientasModel>(url, JSON.stringify(Repositorios),this.httpOptions)
      .pipe(
