 ...
 * Ano			    :2022
 * 
 * Arquitectura	    :Modelo Base de Angular para Arquitectura Microservicios de la Entidad PA_CicloMenuAportesNutricionalesIndustrialesPivSem
 * 
...
/**
 *  decorador injectable indica que esta clase PA_CicloMenuAportesNutricionalesIndustrialesPivSem puede ser inyectada dinamicamente
 *
 *  
 */
 ...
 *  
 */
import { PA_CicloMenuAportesNutricionalesIndustrialesPivSemModel } from "src/app/shared/model/PA_CicloMenuAportesNutricionalesIndustrialesPivSemModel";
 ...
 *  
 */
export class PA_CicloMenuAportesNutricionalesIndustrialesPivSemService {
  constructor(private http: HttpClient,private messageService:MessageService) {}

  // Definición de Variables requeridas
  private apiurl = environment.baseUrlAPI_PTN + "PA_CicloMenuAportesNutricionalesIndustrialesPivSem";
  private filterArray: PA_CicloMenuAportesNutricionalesIndustrialesPivSemModel[] = [];
  private PA_CicloMenuAportesNutricionalesIndustrialesPivSem: PA_CicloMenuAportesNutricionalesIndustrialesPivSemModel[] = [];
  private PA_CicloMenuAportesNutricionalesIndustrialesPivSemList: PA_CicloMenuAportesNutricionalesIndustrialesPivSemModel[] = [];
  private PA_CicloMenuAportesNutricionalesIndustrialesPivSemObject: PA_CicloMenuAportesNutricionalesIndustrialesPivSemModel;
  ...
  private handleError(error: any) {
    ...
    */
 getPA_CicloMenuAportesNutricionalesIndustrialesPivSemList(PA_CicloMenuAportesNutricionalesPiv: PA_CicloMenuAportesNutricionalesIndustrialesPivSem): Observable<PA_CicloMenuAportesNutricionalesIndustrialesPivSemModel> {
  let params = new HttpParams().set('ID_Etc', PA_CicloMenuAportesNutricionalesPiv.ID_Etc);
    ...
    params = PA_CicloMenuAportesNutricionalesPiv.ID_Producto ? params.append('ID_Producto', PA_CicloMenuAportesNutricionalesPiv.ID_Producto) : params;
    ...
    return this.http
      .get<PA_CicloMenuAportesNutricionalesIndustrialesPivSemModel>(url, { params: params })
      .pipe(
...
export class PA_CicloMenuAportesNutricionalesIndustrialesPivSem{
  ID_Etc?: number;
