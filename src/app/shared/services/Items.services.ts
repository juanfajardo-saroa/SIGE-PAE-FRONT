 ...
 * Ano			    :2022
 * 
 * Arquitectura	    :Modelo Base de Angular para Arquitectura Microservicios de la Entidad Items
 * 
...
/**
 *  decorador injectable indica que esta clase Items puede ser inyectada dinamicamente
 *
 *  
 */
...
export class ItemsService {
  ...
  private apiurl = environment.baseUrlAPI_PlanAlistamiento + "Items";
  private filterArray: ItemsModel[] = [];
  private Items: ItemsModel[] = [];
  private ItemsList: ItemsModel[] = [];
  private ItemsObject: ItemsModel;
  ...
  private handleError(error: any) {
    ...
    */
  getItemsList(): Observable<ItemsModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getItemsListFull(): Observable<ItemsModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getItemsListRelation(): Observable<ItemsModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getItems(id: number): Observable<ItemsModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  deleteItems(id: number): Observable<ItemsModel> {

    var ItemsObject = new ItemsModel(id,0,'',0,'',0,'','',
    ...
    return this.http
      .post<ItemsModel>(url, JSON.stringify(ItemsObject),this.httpOptions)
      .pipe(
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  addItems(Items: ItemsModel): Observable<ItemsModel> {
    Items.id = 0;
    Items.auditoria ="{'RolBase':'"+localStorage.getItem("RolBase")+"'},"+
    ...
    Items._usuario=localStorage.getItem('NombreUsuario');
    Items._accion="Adicionar";
    Items._ippublica=localStorage.getItem('IpPublica');
    Items._browser=localStorage.getItem("Browser");
    Items._nombremaquina=localStorage.getItem("NombreMaquina");
    Items._sessionid=localStorage.getItem("Ubicacion");

    const url = `${this.apiurl}/Post/`;
    return this.http
      .post<ItemsModel>(url, JSON.stringify(Items),this.httpOptions)
      .pipe(
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  updateItems(Items: ItemsModel): Observable<ItemsModel> {
    Items.auditoria ="{'RolBase':'"+localStorage.getItem("RolBase")+"'},"+
    "{'RolPersonalizado':'"+          localStorage.getItem("RolPersonalizado")+"'},"+
    "{'NombreUsuario':'"+        localStorage.getItem("NombreUsuario")+"'},"+
    "{'Ubicacion':'"+    localStorage.getItem("Ubicacion")+"'},"+
    ...
    return this.http
      .put<ItemsModel>(url, JSON.stringify(Items),this.httpOptions)
      .pipe(
