 ...
 * Ano			    :2022
 * 
 * Arquitectura	    :Modelo Base de Angular para Arquitectura Microservicios de la Entidad Costos
 * 
...
/**
 *  decorador injectable indica que esta clase Costos puede ser inyectada dinamicamente
 *
 *  
 */
 ...
 *  
 */
import { CostosModel } from "../model/Costos";
...
export class CostosService {
  ...
  private apiurl = environment.baseUrlAPI_PlaneacionFinanciera + "Costos";
  private filterArray: CostosModel[] = [];
  private Costos: CostosModel[] = [];
  private CostosList: CostosModel[] = [];
  private CostosObject: CostosModel;
  ...
  private handleError(error: any) {
    ...
    */
  getCostosList(): Observable<CostosModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getCostosListFull(): Observable<CostosModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getCostosListRelation(): Observable<CostosModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getCostos(id: number): Observable<CostosModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  deleteCostos(id: number): Observable<CostosModel> {

    var CostosObject = new CostosModel(id,0,'',0,0,'',0,'',0,'',0,'',
    ...
    return this.http
      .post<CostosModel>(url, JSON.stringify(CostosObject),this.httpOptions)
      .pipe(
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  addCostos(Costos: CostosModel): Observable<CostosModel> {
    Costos.id = 0;
    Costos.auditoria ="{'RolBase':'"+localStorage.getItem("RolBase")+"'},"+
    ...
    Costos._usuario=localStorage.getItem('NombreUsuario');
    Costos._accion="Adicionar";
    Costos._ippublica=localStorage.getItem('IpPublica');
    Costos._browser=localStorage.getItem("Browser");
    Costos._nombremaquina=localStorage.getItem("NombreMaquina");
    Costos._sessionid=localStorage.getItem("Ubicacion");

    const url = `${this.apiurl}/Post/`;
    return this.http
      .post<CostosModel>(url, JSON.stringify(Costos),this.httpOptions)
      .pipe(
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  updateCostos(Costos: CostosModel): Observable<CostosModel> {
    Costos.auditoria ="{'RolBase':'"+localStorage.getItem("RolBase")+"'},"+
    "{'RolPersonalizado':'"+          localStorage.getItem("RolPersonalizado")+"'},"+
    "{'NombreUsuario':'"+        localStorage.getItem("NombreUsuario")+"'},"+
    "{'Ubicacion':'"+    localStorage.getItem("Ubicacion")+"'},"+
    ...
    return this.http
      .put<CostosModel>(url, JSON.stringify(Costos),this.httpOptions)
      .pipe(
