...
/**
 *  decorador injectable indica que esta clase Proveedores puede ser inyectada dinamicamente
 *
 *  
 */
 ...
 *  
 */
import { ProveedoresModel } from "../model/Proveedores";
...
export class ProveedoresService {
  ...
  private apiurl = environment.baseUrlAPI_Seguimiento + "Proveedores";
  private filterArray: ProveedoresModel[] = [];
  private Proveedores: ProveedoresModel[] = [];
  private ProveedoresList: ProveedoresModel[] = [];
  private ProveedoresObject: ProveedoresModel;
  ...
  getProveedoresList(): Observable<ProveedoresModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getProveedoresListFull(): Observable<ProveedoresModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  getProveedoresListRelation(): Observable<ProveedoresModel> {
  ...
  getProveedores(id: number): Observable<ProveedoresModel> {
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  deleteProveedores(id: number): Observable<ProveedoresModel> {

    var ProveedoresObject = new ProveedoresModel(id,0,'','','','','','','','','',0,0,0,'',
    ...
    return this.http
      .post<ProveedoresModel>(url, JSON.stringify(ProveedoresObject),this.httpOptions)
      .pipe(
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  addProveedores(Proveedores: ProveedoresModel): Observable<ProveedoresModel> {
    Proveedores.id = 0;
    Proveedores.auditoria ="{'RolBase':'"+localStorage.getItem("RolBase")+"'},"+
    ...
    Proveedores._usuario=localStorage.getItem('NombreUsuario');
    Proveedores._accion="Adicionar";
    Proveedores._ippublica=localStorage.getItem('IpPublica');
    Proveedores._browser=localStorage.getItem("Browser");
    Proveedores._nombremaquina=localStorage.getItem("NombreMaquina");
    Proveedores._sessionid=localStorage.getItem("Ubicacion");

    const url = `${this.apiurl}/Post/`;
    return this.http
      .post<ProveedoresModel>(url, JSON.stringify(Proveedores),this.httpOptions)
      .pipe(
    ...
    *   Como esta clase esta soportada sobre dapper permite realizar filtros en formato LINQ
    */
  updateProveedores(Proveedores: ProveedoresModel): Observable<ProveedoresModel> {
    Proveedores.auditoria ="{'RolBase':'"+localStorage.getItem("RolBase")+"'},"+
    "{'RolPersonalizado':'"+          localStorage.getItem("RolPersonalizado")+"'},"+
    "{'NombreUsuario':'"+        localStorage.getItem("NombreUsuario")+"'},"+
    "{'Ubicacion':'"+    localStorage.getItem("Ubicacion")+"'},"+
    ...
    "{'NombreMaquina':'"+        localStorage.getItem("NombreMaquina")+"'}";
    Proveedores._usuario=localStorage.getItem('NombreUsuario');
    Proveedores._accion="Actuializar";
    Proveedores._ippublica=localStorage.getItem('IpPublica');
    Proveedores._browser=localStorage.getItem("Browser");
    Proveedores._nombremaquina=localStorage.getItem("NombreMaquina");
    Proveedores._sessionid=localStorage.getItem("Ubicacion");
    ...
    return this.http
      .put<ProveedoresModel>(url, JSON.stringify(Proveedores),this.httpOptions)
      .pipe(
